...
**Error** | Pointer to **NullableString** | An error message when an operation has failed. | [optional] 
...
`func (o *NatGatewayModelOverview) SetIpAddressesNil(b bool)`

 SetIpAddressesNil sets the value for IpAddresses to be an explicit nil

### UnsetIpAddresses
`func (o *NatGatewayModelOverview) UnsetIpAddresses()`
...
`func (o *NatGatewayModelOverview) SetErrorNil(b bool)`
