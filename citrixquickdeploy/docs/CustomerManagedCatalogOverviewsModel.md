...
`func (o *CustomerManagedCatalogOverviewsModel) SetCatalogsNil(b bool)`

 SetCatalogsNil sets the value for Catalogs to be an explicit nil

### UnsetCatalogs
`func (o *CustomerManagedCatalogOverviewsModel) UnsetCatalogs()`
...
`func (o *CustomerManagedCatalogOverviewsModel) SetCatalogLimitNil(b bool)`
