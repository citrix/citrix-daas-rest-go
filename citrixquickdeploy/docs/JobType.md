...
* `SET_TAG_DESKTOPS` (value: `"SetTagDesktops"`)

* `SET_TAG_MACHINE_CATALOGS` (value: `"SetTagMachineCatalogs"`)
...
* `CREATE_RESOURCE_ACCESS_POLICY` (value: `"CreateResourceAccessPolicy"`)

* `UPDATE_RESOURCE_ACCESS_POLICY` (value: `"UpdateResourceAccessPolicy"`)

* `DELETE_RESOURCE_ACCESS_POLICY` (value: `"DeleteResourceAccessPolicy"`)
...
* `LOGOFF_MACHINE_SESSIONS` (value: `"LogoffMachineSessions"`)
...
* `DO_DELIVERY_GROUP_SEARCH` (value: `"DoDeliveryGroupSearch"`)
...
* `GET_DOMAINS_IDENTITY` (value: `"GetDomainsIdentity"`)

* `GET_FORESTS_IDENTITY` (value: `"GetForestsIdentity"`)
...
* `GET_TAGS_ASSOCIATED_WITH_ENTITLEMENT_RULE` (value: `"GetTagsAssociatedWithEntitlementRule"`)
...
* `SYNC_CLOUD_CONNECTORS` (value: `"SyncCloudConnectors"`)

* `TEST_MACHINE` (value: `"TestMachine"`)

* `GET_PROVISIONING_SCHEMES_DETAILS` (value: `"GetProvisioningSchemesDetails"`)

* `CREATE_PROVISIONING_SCHEME_CONFIGURATION` (value: `"CreateProvisioningSchemeConfiguration"`)

* `REMOVE_PROVISIONING_SCHEME_CONFIGURATION` (value: `"RemoveProvisioningSchemeConfiguration"`)

* `CREATE_PROVISIONED_VIRTUAL_MACHINE_CONFIGURATION` (value: `"CreateProvisionedVirtualMachineConfiguration"`)

* `REMOVE_PROVISIONED_VIRTUAL_MACHINE_CONFIGURATION` (value: `"RemoveProvisionedVirtualMachineConfiguration"`)

* `SCHEDULE_PROVISIONING_SCHEME_HARDWARE_UPDATE` (value: `"ScheduleProvisioningSchemeHardwareUpdate"`)

* `SCHEDULE_PROVISIONED_VIRTUAL_MACHINE_HARDWARE_UPDATE` (value: `"ScheduleProvisionedVirtualMachineHardwareUpdate"`)

* `CREATE_PROVISIONED_VM_CONFIGURATION_AND_SCHEDULE_UPDATE` (value: `"CreateProvisionedVMConfigurationAndScheduleUpdate"`)

* `UPDATE_MACHINE_CATALOG_PVS_SCHEME_V_DISK` (value: `"UpdateMachineCatalogPvsSchemeVDisk"`)

* `UPDATE_MACHINE_CATALOG_PVS_SCHEME_BDM` (value: `"UpdateMachineCatalogPvsSchemeBdm"`)

* `ICON_DISCOVERY` (value: `"IconDiscovery"`)

* `UPDATE_PROVISIONED_BACKUP` (value: `"UpdateProvisionedBackup"`)

* `DELETE_PROVISIONED_BACKUP` (value: `"DeleteProvisionedBackup"`)

* `SCHEDULE_TAKE_PROVISIONED_BACKUP` (value: `"ScheduleTakeProvisionedBackup"`)

* `SCHEDULE_RESTORE_TO_PROVISIONED_BACKUP` (value: `"ScheduleRestoreToProvisionedBackup"`)

* `GET_TASKS` (value: `"GetTasks"`)

* `DELETE_TASK` (value: `"DeleteTask"`)

* `CANCEL_TASK` (value: `"CancelTask"`)

* `GET_TASK_DETAILS` (value: `"GetTaskDetails"`)

* `RESTART_TASK` (value: `"RestartTask"`)

* `UPDATE_TASK` (value: `"UpdateTask"`)

* `SCHEDULE_RESET_PROVISIONED_VIRTUAL_MACHINE_OS_DISK` (value: `"ScheduleResetProvisionedVirtualMachineOSDisk"`)

* `GET_TASK_SUB_JOBS` (value: `"GetTaskSubJobs"`)

* `SELECT_ALL_ACTION` (value: `"SelectAllAction"`)

* `DO_TASK_SEARCH` (value: `"DoTaskSearch"`)

* `DO_TASK_SUB_JOB_SEARCH` (value: `"DoTaskSubJobSearch"`)

* `DO_SCHEDULE_SEARCH` (value: `"DoScheduleSearch"`)

* `DELETE_SCHEDULE` (value: `"DeleteSchedule"`)

* `CONFIRM_PROVISIONING_SCHEME_OPERATION_EVENTS` (value: `"ConfirmProvisioningSchemeOperationEvents"`)

* `CONFIRM_PROVISIONED_VIRTUAL_MACHINE_OPERATION_EVENTS` (value: `"ConfirmProvisionedVirtualMachineOperationEvents"`)

* `SCHEDULE_PROVISIONING_SCHEME_IMAGE_UPDATE` (value: `"ScheduleProvisioningSchemeImageUpdate"`)

* `GET_DIRECTORIES` (value: `"GetDirectories"`)
