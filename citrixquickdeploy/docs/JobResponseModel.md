...
**Type** | [**JobType**](JobType.md) | Type of job that is being performed. | 
...
**Status** | [**JobStatus**](JobStatus.md) | State of the job or subjob. | 
...
**ErrorCode** | Pointer to [**NullableJobErrorCode**](JobErrorCode.md) | If a job or subjob failed, this will be the reason why    the failure occurred. | [optional] 
...
`func (o *JobResponseModel) SetErrorCodeNil(b bool)`

 SetErrorCodeNil sets the value for ErrorCode to be an explicit nil

### UnsetErrorCode
`func (o *JobResponseModel) UnsetErrorCode()`
