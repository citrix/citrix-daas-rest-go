...
* `UNKNOWN_HYPERVISOR_CONNECTION` (value: `"UnknownHypervisorConnection"`)
...
* `PVS_FOR_VM_INVALID` (value: `"PvsForVMInvalid"`)
...
* `NAMING_SCHEME_ILLEGAL_CHARACTER` (value: `"NamingSchemeIllegalCharacter"`)
...
* `DUPLICATE_AUTOSCALE_GROUP_PLUGIN_NAME` (value: `"DuplicateAutoscaleGroupPluginName"`)
...
* `CITRIX_LICENSING_VENDOR_OR_SERVICE_DOWN` (value: `"CitrixLicensingVendorOrServiceDown"`)
...
* `POWER_ACTION_IGNORED` (value: `"PowerActionIgnored"`)
...
* `AWS_ASSUME_ROLE_AUTHENTICATION_FAILURE` (value: `"AWSAssumeRoleAuthenticationFailure"`)

* `AMULET_HOTKEY_CORE_STATION_CONNECTION_SSL_FAILURE` (value: `"AmuletHotkeyCoreStationConnectionSslFailure"`)

* `AMULET_HOTKEY_CORE_STATION_CONNECTION_SSL_PRIVATE_CA_SIGNED_FAILURE` (value: `"AmuletHotkeyCoreStationConnectionSslPrivateCASignedFailure"`)

* `AMULET_HOTKEY_CORE_STATION_CONNECTION_SSL_PUBLIC_CA_SIGNED_FAILURE` (value: `"AmuletHotkeyCoreStationConnectionSslPublicCASignedFailure"`)
