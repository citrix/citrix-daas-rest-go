...
type JobResponseModel struct {
	...
	Id string `json:"id"`
	// Type of job that is being performed.
	...
	// If a job or subjob failed, this will be the reason why    the failure occurred.
	ErrorCode NullableJobErrorCode `json:"errorCode,omitempty"`
...
// SetErrorCode gets a reference to the given NullableJobErrorCode and assigns it to the ErrorCode field.
func (o *JobResponseModel) SetErrorCode(v JobErrorCode) {
	o.ErrorCode.Set(&v)
}

// SetErrorCodeNil sets the value for ErrorCode to be an explicit nil
func (o *JobResponseModel) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
