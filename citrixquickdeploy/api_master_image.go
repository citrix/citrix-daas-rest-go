...
type MasterImageCMD interface {
	...
	*/
	ImportTemplateImageWithoutVerification(ctx context.Context, customerId string, siteId string) ApiImportTemplateImageWithoutVerificationRequest

	// ImportTemplateImageWithoutVerificationExecute executes the request
	//  @return TemplateImageOverview
	ImportTemplateImageWithoutVerificationExecute(r ApiImportTemplateImageWithoutVerificationRequest) (*TemplateImageOverview, *http.Response, error)
