...
const (
	AWSACCOUNTRESOURCETYPE_AWS_DIRECTORY         AwsAccountResourceType = "AWS_DIRECTORY"
	AWSACCOUNTRESOURCETYPE_AWS_VPC               AwsAccountResourceType = "AWS_VPC"
	AWSACCOUNTRESOURCETYPE_AWS_SUBNET            AwsAccountResourceType = "AWS_SUBNET"
	AWSACCOUNTRESOURCETYPE_AWS_SECGROUP          AwsAccountResourceType = "AWS_SECGROUP"
	AWSACCOUNTRESOURCETYPE_AWS_CIDRRANGE         AwsAccountResourceType = "AWS_CIDRRANGE"
	AWSACCOUNTRESOURCETYPE_AWS_AMI               AwsAccountResourceType = "AWS_AMI"
	AWSACCOUNTRESOURCETYPE_AWS_REGIONS           AwsAccountResourceType = "AWS_REGIONS"
	AWSACCOUNTRESOURCETYPE_AWS_BYOL_REGISTRATION AwsAccountResourceType = "AWS_BYOL_REGISTRATION"
	AWSACCOUNTRESOURCETYPE_AWS_CITRIXIAMUSER     AwsAccountResourceType = "AWS_CITRIXIAMUSER"
	AWSACCOUNTRESOURCETYPE_AWS_CLOUDFORMATION    AwsAccountResourceType = "AWS_CLOUDFORMATION"
	AWSACCOUNTRESOURCETYPE_AWS_EC2_INSTANCE_TYPE AwsAccountResourceType = "AWS_EC2_INSTANCE_TYPE"
	AWSACCOUNTRESOURCETYPE_AWS_EC2_KEY_PAIR      AwsAccountResourceType = "AWS_EC2_KEY_PAIR"
)
