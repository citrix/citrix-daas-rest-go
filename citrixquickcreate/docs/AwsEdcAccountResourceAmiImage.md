...
**Status** | Pointer to [**NullableAwsEdcAmiImageStatus**](AwsEdcAmiImageStatus.md) |  | [optional] 
**Location** | Pointer to **NullableString** | Image Location | [optional] 
**ImageType** | Pointer to [**NullableAwsEdcAmiImageType**](AwsEdcAmiImageType.md) |  | [optional] 
**PlatformType** | Pointer to [**NullableAwsEdcAmiImagePlatform**](AwsEdcAmiImagePlatform.md) |  | [optional] 
**BootMode** | Pointer to [**NullableAwsEdcAmiImageBootMode**](AwsEdcAmiImageBootMode.md) |  | [optional] 
**ArchitectureType** | Pointer to [**NullableAwsEdcAmiImageArchitecture**](AwsEdcAmiImageArchitecture.md) |  | [optional] 
**VirtualizationType** | Pointer to [**NullableAwsEdcAmiImageVirtualization**](AwsEdcAmiImageVirtualization.md) |  | [optional] 
