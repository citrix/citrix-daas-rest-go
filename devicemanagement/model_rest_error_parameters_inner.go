...
// checks if the RestErrorParametersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestErrorParametersInner{}
...
type _RestErrorParametersInner RestErrorParametersInner
...
type NullableRestErrorParametersInner struct {
	value *RestErrorParametersInner
	isSet bool
}
...
func NewNullableRestErrorParametersInner(val *RestErrorParametersInner) *NullableRestErrorParametersInner {
	return &NullableRestErrorParametersInner{value: val, isSet: true}
}
