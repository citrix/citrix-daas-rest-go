...
// APIClient manages communication with the Citrix.CloudServices.Cws.Api API v1.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AuthDomainsDAAS = (*AuthDomainsDAASService)(&c.common)
	c.IdentityProvidersDAAS = (*IdentityProvidersDAASService)(&c.common)
