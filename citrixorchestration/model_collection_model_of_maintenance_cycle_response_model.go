...
// checks if the CollectionModelOfMaintenanceCycleResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfMaintenanceCycleResponseModel{}

// CollectionModelOfMaintenanceCycleResponseModel Response object for collections of items.
type CollectionModelOfMaintenanceCycleResponseModel struct {
	// List of items.
...
type _CollectionModelOfMaintenanceCycleResponseModel CollectionModelOfMaintenanceCycleResponseModel
...
func NewCollectionModelOfMaintenanceCycleResponseModel(items []MaintenanceCycleResponseModel) *CollectionModelOfMaintenanceCycleResponseModel {
	this := CollectionModelOfMaintenanceCycleResponseModel{}
	this.Items = items
	return &this
}
...
func (o CollectionModelOfMaintenanceCycleResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfMaintenanceCycleResponseModel struct {
	value *CollectionModelOfMaintenanceCycleResponseModel
	isSet bool
}

func (v NullableCollectionModelOfMaintenanceCycleResponseModel) Get() *CollectionModelOfMaintenanceCycleResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfMaintenanceCycleResponseModel) Set(val *CollectionModelOfMaintenanceCycleResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfMaintenanceCycleResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfMaintenanceCycleResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfMaintenanceCycleResponseModel(val *CollectionModelOfMaintenanceCycleResponseModel) *NullableCollectionModelOfMaintenanceCycleResponseModel {
	return &NullableCollectionModelOfMaintenanceCycleResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfMaintenanceCycleResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfMaintenanceCycleResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
