...
// checks if the HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath{}

// HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath Root resource path, within the full set of hypervisor resources, in which the resource pool resides.
type HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath struct {
	// Id of the resource.
...
func NewHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath() *HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath {
	this := HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath{}
	return &this
}
...
func (o HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath struct {
	value *HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath
	isSet bool
}

func (v NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) Get() *HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath {
	return v.value
}

func (v *NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) Set(val *HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath(val *HypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) *NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath {
	return &NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolTraditionalDetailResponseModelAllOfRootPath) UnmarshalJSON(src []byte) error {
	v.isSet = true
