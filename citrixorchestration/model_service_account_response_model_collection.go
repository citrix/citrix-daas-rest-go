...
// checks if the ServiceAccountResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountResponseModelCollection{}

// ServiceAccountResponseModelCollection struct for ServiceAccountResponseModelCollection
type ServiceAccountResponseModelCollection struct {
	// List of items.
...
type _ServiceAccountResponseModelCollection ServiceAccountResponseModelCollection
...
func NewServiceAccountResponseModelCollection(items []ServiceAccountResponseModel) *ServiceAccountResponseModelCollection {
	this := ServiceAccountResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ServiceAccountResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ServiceAccountResponseModelCollection) SetTotalItemsNil() {
...
func (o ServiceAccountResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ServiceAccountResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableServiceAccountResponseModelCollection struct {
	value *ServiceAccountResponseModelCollection
	isSet bool
}

func (v NullableServiceAccountResponseModelCollection) Get() *ServiceAccountResponseModelCollection {
	return v.value
}

func (v *NullableServiceAccountResponseModelCollection) Set(val *ServiceAccountResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceAccountResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceAccountResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceAccountResponseModelCollection(val *ServiceAccountResponseModelCollection) *NullableServiceAccountResponseModelCollection {
	return &NullableServiceAccountResponseModelCollection{value: val, isSet: true}
}

func (v NullableServiceAccountResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceAccountResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
