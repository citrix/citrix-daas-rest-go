...
// checks if the MaintenanceCycleResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceCycleResponseModelCollection{}

// MaintenanceCycleResponseModelCollection struct for MaintenanceCycleResponseModelCollection
type MaintenanceCycleResponseModelCollection struct {
	// List of items.
	Items []MaintenanceCycleResponseModel `json:"Items"`
...
type _MaintenanceCycleResponseModelCollection MaintenanceCycleResponseModelCollection
...
func NewMaintenanceCycleResponseModelCollection(items []MaintenanceCycleResponseModel) *MaintenanceCycleResponseModelCollection {
	this := MaintenanceCycleResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *MaintenanceCycleResponseModelCollection) GetItems() []MaintenanceCycleResponseModel {
	if o == nil {
		var ret []MaintenanceCycleResponseModel
		return ret
	}
...
func (o *MaintenanceCycleResponseModelCollection) SetContinuationTokenNil() {
...
func (o *MaintenanceCycleResponseModelCollection) SetTotalItemsNil() {
...
func (o MaintenanceCycleResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o MaintenanceCycleResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableMaintenanceCycleResponseModelCollection struct {
	value *MaintenanceCycleResponseModelCollection
	isSet bool
}

func (v NullableMaintenanceCycleResponseModelCollection) Get() *MaintenanceCycleResponseModelCollection {
	return v.value
}

func (v *NullableMaintenanceCycleResponseModelCollection) Set(val *MaintenanceCycleResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceCycleResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceCycleResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceCycleResponseModelCollection(val *MaintenanceCycleResponseModelCollection) *NullableMaintenanceCycleResponseModelCollection {
	return &NullableMaintenanceCycleResponseModelCollection{value: val, isSet: true}
}

func (v NullableMaintenanceCycleResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceCycleResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
