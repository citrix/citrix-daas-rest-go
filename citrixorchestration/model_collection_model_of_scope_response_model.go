...
// checks if the CollectionModelOfScopeResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfScopeResponseModel{}

// CollectionModelOfScopeResponseModel Response object for collections of items.
type CollectionModelOfScopeResponseModel struct {
	// List of items.
...
type _CollectionModelOfScopeResponseModel CollectionModelOfScopeResponseModel
...
func NewCollectionModelOfScopeResponseModel(items []ScopeResponseModel) *CollectionModelOfScopeResponseModel {
	this := CollectionModelOfScopeResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfScopeResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfScopeResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfScopeResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfScopeResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfScopeResponseModel struct {
	value *CollectionModelOfScopeResponseModel
	isSet bool
}

func (v NullableCollectionModelOfScopeResponseModel) Get() *CollectionModelOfScopeResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfScopeResponseModel) Set(val *CollectionModelOfScopeResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfScopeResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfScopeResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfScopeResponseModel(val *CollectionModelOfScopeResponseModel) *NullableCollectionModelOfScopeResponseModel {
	return &NullableCollectionModelOfScopeResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfScopeResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfScopeResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
