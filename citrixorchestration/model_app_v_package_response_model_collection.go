...
// checks if the AppVPackageResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVPackageResponseModelCollection{}

// AppVPackageResponseModelCollection struct for AppVPackageResponseModelCollection
type AppVPackageResponseModelCollection struct {
	// List of items.
...
type _AppVPackageResponseModelCollection AppVPackageResponseModelCollection
...
func NewAppVPackageResponseModelCollection(items []AppVPackageResponseModel) *AppVPackageResponseModelCollection {
	this := AppVPackageResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AppVPackageResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AppVPackageResponseModelCollection) SetTotalItemsNil() {
...
func (o AppVPackageResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AppVPackageResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppVPackageResponseModelCollection struct {
	value *AppVPackageResponseModelCollection
	isSet bool
}

func (v NullableAppVPackageResponseModelCollection) Get() *AppVPackageResponseModelCollection {
	return v.value
}

func (v *NullableAppVPackageResponseModelCollection) Set(val *AppVPackageResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVPackageResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVPackageResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVPackageResponseModelCollection(val *AppVPackageResponseModelCollection) *NullableAppVPackageResponseModelCollection {
	return &NullableAppVPackageResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppVPackageResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVPackageResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
