...
// checks if the ImageVersionProvisioningSchemeRefResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageVersionProvisioningSchemeRefResponseModelCollection{}

// ImageVersionProvisioningSchemeRefResponseModelCollection struct for ImageVersionProvisioningSchemeRefResponseModelCollection
type ImageVersionProvisioningSchemeRefResponseModelCollection struct {
	// List of items.
...
type _ImageVersionProvisioningSchemeRefResponseModelCollection ImageVersionProvisioningSchemeRefResponseModelCollection
...
func NewImageVersionProvisioningSchemeRefResponseModelCollection(items []ImageVersionProvisioningSchemeRefResponseModel) *ImageVersionProvisioningSchemeRefResponseModelCollection {
	this := ImageVersionProvisioningSchemeRefResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ImageVersionProvisioningSchemeRefResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ImageVersionProvisioningSchemeRefResponseModelCollection) SetTotalItemsNil() {
...
func (o ImageVersionProvisioningSchemeRefResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ImageVersionProvisioningSchemeRefResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableImageVersionProvisioningSchemeRefResponseModelCollection struct {
	value *ImageVersionProvisioningSchemeRefResponseModelCollection
	isSet bool
}

func (v NullableImageVersionProvisioningSchemeRefResponseModelCollection) Get() *ImageVersionProvisioningSchemeRefResponseModelCollection {
	return v.value
}

func (v *NullableImageVersionProvisioningSchemeRefResponseModelCollection) Set(val *ImageVersionProvisioningSchemeRefResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableImageVersionProvisioningSchemeRefResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableImageVersionProvisioningSchemeRefResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageVersionProvisioningSchemeRefResponseModelCollection(val *ImageVersionProvisioningSchemeRefResponseModelCollection) *NullableImageVersionProvisioningSchemeRefResponseModelCollection {
	return &NullableImageVersionProvisioningSchemeRefResponseModelCollection{value: val, isSet: true}
}

func (v NullableImageVersionProvisioningSchemeRefResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageVersionProvisioningSchemeRefResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
