...
// checks if the AdminFolderResponseModelParent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminFolderResponseModelParent{}

// AdminFolderResponseModelParent Parent folder.
type AdminFolderResponseModelParent struct {
...
func NewAdminFolderResponseModelParent() *AdminFolderResponseModelParent {
	this := AdminFolderResponseModelParent{}
	return &this
}
...
func (o AdminFolderResponseModelParent) MarshalJSON() ([]byte, error) {
...
func (o AdminFolderResponseModelParent) ToMap() (map[string]interface{}, error) {
...
type NullableAdminFolderResponseModelParent struct {
	value *AdminFolderResponseModelParent
	isSet bool
}

func (v NullableAdminFolderResponseModelParent) Get() *AdminFolderResponseModelParent {
	return v.value
}

func (v *NullableAdminFolderResponseModelParent) Set(val *AdminFolderResponseModelParent) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminFolderResponseModelParent) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminFolderResponseModelParent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminFolderResponseModelParent(val *AdminFolderResponseModelParent) *NullableAdminFolderResponseModelParent {
	return &NullableAdminFolderResponseModelParent{value: val, isSet: true}
}

func (v NullableAdminFolderResponseModelParent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminFolderResponseModelParent) UnmarshalJSON(src []byte) error {
	v.isSet = true
