...
// checks if the CollectionModelOfLicensingUserResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfLicensingUserResponseModel{}

// CollectionModelOfLicensingUserResponseModel Response object for collections of items.
type CollectionModelOfLicensingUserResponseModel struct {
	// List of items.
...
type _CollectionModelOfLicensingUserResponseModel CollectionModelOfLicensingUserResponseModel
...
func NewCollectionModelOfLicensingUserResponseModel(items []LicensingUserResponseModel) *CollectionModelOfLicensingUserResponseModel {
	this := CollectionModelOfLicensingUserResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfLicensingUserResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfLicensingUserResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfLicensingUserResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfLicensingUserResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfLicensingUserResponseModel struct {
	value *CollectionModelOfLicensingUserResponseModel
	isSet bool
}

func (v NullableCollectionModelOfLicensingUserResponseModel) Get() *CollectionModelOfLicensingUserResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfLicensingUserResponseModel) Set(val *CollectionModelOfLicensingUserResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfLicensingUserResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfLicensingUserResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfLicensingUserResponseModel(val *CollectionModelOfLicensingUserResponseModel) *NullableCollectionModelOfLicensingUserResponseModel {
	return &NullableCollectionModelOfLicensingUserResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfLicensingUserResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfLicensingUserResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
