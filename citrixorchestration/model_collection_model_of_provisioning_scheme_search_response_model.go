...
// checks if the CollectionModelOfProvisioningSchemeSearchResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisioningSchemeSearchResponseModel{}

// CollectionModelOfProvisioningSchemeSearchResponseModel Response object for collections of items.
type CollectionModelOfProvisioningSchemeSearchResponseModel struct {
	// List of items.
	Items []ProvisioningSchemeSearchResponseModel `json:"Items"`
...
type _CollectionModelOfProvisioningSchemeSearchResponseModel CollectionModelOfProvisioningSchemeSearchResponseModel
...
func NewCollectionModelOfProvisioningSchemeSearchResponseModel(items []ProvisioningSchemeSearchResponseModel) *CollectionModelOfProvisioningSchemeSearchResponseModel {
	this := CollectionModelOfProvisioningSchemeSearchResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisioningSchemeSearchResponseModel) GetItems() []ProvisioningSchemeSearchResponseModel {
	if o == nil {
		var ret []ProvisioningSchemeSearchResponseModel
		return ret
	}
...
func (o *CollectionModelOfProvisioningSchemeSearchResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisioningSchemeSearchResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisioningSchemeSearchResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisioningSchemeSearchResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisioningSchemeSearchResponseModel struct {
	value *CollectionModelOfProvisioningSchemeSearchResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisioningSchemeSearchResponseModel) Get() *CollectionModelOfProvisioningSchemeSearchResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisioningSchemeSearchResponseModel) Set(val *CollectionModelOfProvisioningSchemeSearchResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisioningSchemeSearchResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisioningSchemeSearchResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisioningSchemeSearchResponseModel(val *CollectionModelOfProvisioningSchemeSearchResponseModel) *NullableCollectionModelOfProvisioningSchemeSearchResponseModel {
	return &NullableCollectionModelOfProvisioningSchemeSearchResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisioningSchemeSearchResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisioningSchemeSearchResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
