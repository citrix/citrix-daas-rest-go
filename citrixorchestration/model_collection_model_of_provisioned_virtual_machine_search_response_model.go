...
// checks if the CollectionModelOfProvisionedVirtualMachineSearchResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisionedVirtualMachineSearchResponseModel{}

// CollectionModelOfProvisionedVirtualMachineSearchResponseModel Response object for collections of items.
type CollectionModelOfProvisionedVirtualMachineSearchResponseModel struct {
	// List of items.
	Items []ProvisionedVirtualMachineSearchResponseModel `json:"Items"`
...
type _CollectionModelOfProvisionedVirtualMachineSearchResponseModel CollectionModelOfProvisionedVirtualMachineSearchResponseModel
...
func NewCollectionModelOfProvisionedVirtualMachineSearchResponseModel(items []ProvisionedVirtualMachineSearchResponseModel) *CollectionModelOfProvisionedVirtualMachineSearchResponseModel {
	this := CollectionModelOfProvisionedVirtualMachineSearchResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisionedVirtualMachineSearchResponseModel) GetItems() []ProvisionedVirtualMachineSearchResponseModel {
	if o == nil {
		var ret []ProvisionedVirtualMachineSearchResponseModel
		return ret
	}
...
func (o *CollectionModelOfProvisionedVirtualMachineSearchResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisionedVirtualMachineSearchResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisionedVirtualMachineSearchResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisionedVirtualMachineSearchResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel struct {
	value *CollectionModelOfProvisionedVirtualMachineSearchResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) Get() *CollectionModelOfProvisionedVirtualMachineSearchResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) Set(val *CollectionModelOfProvisionedVirtualMachineSearchResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel(val *CollectionModelOfProvisionedVirtualMachineSearchResponseModel) *NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel {
	return &NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisionedVirtualMachineSearchResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
