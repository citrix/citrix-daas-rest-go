...
// checks if the CollectionModelOfString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfString{}

// CollectionModelOfString Response object for collections of items.
type CollectionModelOfString struct {
	// List of items.
...
func (o *CollectionModelOfString) SetContinuationTokenNil() {
...
func (o *CollectionModelOfString) SetTotalItemsNil() {
...
func (o CollectionModelOfString) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfString) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfString struct {
	value *CollectionModelOfString
	isSet bool
}

func (v NullableCollectionModelOfString) Get() *CollectionModelOfString {
	return v.value
}

func (v *NullableCollectionModelOfString) Set(val *CollectionModelOfString) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfString) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfString) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfString(val *CollectionModelOfString) *NullableCollectionModelOfString {
	return &NullableCollectionModelOfString{value: val, isSet: true}
}

func (v NullableCollectionModelOfString) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfString) UnmarshalJSON(src []byte) error {
	v.isSet = true
