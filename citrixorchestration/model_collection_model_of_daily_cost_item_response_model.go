...
// checks if the CollectionModelOfDailyCostItemResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfDailyCostItemResponseModel{}

// CollectionModelOfDailyCostItemResponseModel Response object for collections of items.
type CollectionModelOfDailyCostItemResponseModel struct {
	// List of items.
	Items []DailyCostItemResponseModel `json:"Items"`
...
type _CollectionModelOfDailyCostItemResponseModel CollectionModelOfDailyCostItemResponseModel
...
func NewCollectionModelOfDailyCostItemResponseModel(items []DailyCostItemResponseModel) *CollectionModelOfDailyCostItemResponseModel {
	this := CollectionModelOfDailyCostItemResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfDailyCostItemResponseModel) GetItems() []DailyCostItemResponseModel {
	if o == nil {
		var ret []DailyCostItemResponseModel
		return ret
	}
...
func (o *CollectionModelOfDailyCostItemResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfDailyCostItemResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfDailyCostItemResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfDailyCostItemResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfDailyCostItemResponseModel struct {
	value *CollectionModelOfDailyCostItemResponseModel
	isSet bool
}

func (v NullableCollectionModelOfDailyCostItemResponseModel) Get() *CollectionModelOfDailyCostItemResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfDailyCostItemResponseModel) Set(val *CollectionModelOfDailyCostItemResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfDailyCostItemResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfDailyCostItemResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfDailyCostItemResponseModel(val *CollectionModelOfDailyCostItemResponseModel) *NullableCollectionModelOfDailyCostItemResponseModel {
	return &NullableCollectionModelOfDailyCostItemResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfDailyCostItemResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfDailyCostItemResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
