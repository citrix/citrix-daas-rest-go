...
// checks if the CollectionModelOfZonedItemResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfZonedItemResponseModel{}

// CollectionModelOfZonedItemResponseModel Response object for collections of items.
type CollectionModelOfZonedItemResponseModel struct {
	// List of items.
	Items []ZonedItemResponseModel `json:"Items"`
...
type _CollectionModelOfZonedItemResponseModel CollectionModelOfZonedItemResponseModel
...
func NewCollectionModelOfZonedItemResponseModel(items []ZonedItemResponseModel) *CollectionModelOfZonedItemResponseModel {
	this := CollectionModelOfZonedItemResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfZonedItemResponseModel) GetItems() []ZonedItemResponseModel {
	if o == nil {
		var ret []ZonedItemResponseModel
		return ret
	}
...
func (o *CollectionModelOfZonedItemResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfZonedItemResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfZonedItemResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfZonedItemResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfZonedItemResponseModel struct {
	value *CollectionModelOfZonedItemResponseModel
	isSet bool
}

func (v NullableCollectionModelOfZonedItemResponseModel) Get() *CollectionModelOfZonedItemResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfZonedItemResponseModel) Set(val *CollectionModelOfZonedItemResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfZonedItemResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfZonedItemResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfZonedItemResponseModel(val *CollectionModelOfZonedItemResponseModel) *NullableCollectionModelOfZonedItemResponseModel {
	return &NullableCollectionModelOfZonedItemResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfZonedItemResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfZonedItemResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
