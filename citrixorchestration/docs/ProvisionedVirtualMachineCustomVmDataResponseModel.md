...
**PersistWriteBackCache** | Pointer to **NullableBool** | Retaining Write-back Cache Disk | [optional] 
...
**WriteBackCacheDiskId** | Pointer to **NullableString** | Write Back Cache Disk full path | [optional] 
**WriteBackCacheDiskStorageType** | Pointer to **NullableString** | Write Back Cache Disk Storage Type | [optional] 
