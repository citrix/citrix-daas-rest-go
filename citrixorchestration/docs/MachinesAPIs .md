...
------------- | ------------- | -------------
[**MachinesAddMachineTags**](MachinesAPIs .md#MachinesAddMachineTags) | **Post** /Machines/{nameOrId}/Tags/{tagNameOrId} | Add a tag to a machine.
[**MachinesCheckMachineExists**](MachinesAPIs .md#MachinesCheckMachineExists) | **Head** /Machines/{name} | Check for the existence of a machine by name.
[**MachinesCreateMachineUpgradeSchedule**](MachinesAPIs .md#MachinesCreateMachineUpgradeSchedule) | **Post** /Machines/{nameOrId}/UpgradeSchedule | Setup a new VDA upgrade schedule for a machine.
[**MachinesDisconnectSessions**](MachinesAPIs .md#MachinesDisconnectSessions) | **Post** /Machines/{nameOrId}/$disconnect | Disconnect all sessions on a machine.
[**MachinesDoMachineSearch**](MachinesAPIs .md#MachinesDoMachineSearch) | **Post** /Machines/$search | Perform an advanced search for machines.
[**MachinesGetMachine**](MachinesAPIs .md#MachinesGetMachine) | **Get** /Machines/{nameOrId} | Get details of a single machine.
[**MachinesGetMachineApplications**](MachinesAPIs .md#MachinesGetMachineApplications) | **Get** /Machines/{nameOrId}/Applications | Get the list of applications on a machine.
[**MachinesGetMachineDeliveryGroup**](MachinesAPIs .md#MachinesGetMachineDeliveryGroup) | **Get** /Machines/{nameOrId}/DeliveryGroup | Get the delivery group for a machine.
[**MachinesGetMachineDesktop**](MachinesAPIs .md#MachinesGetMachineDesktop) | **Get** /Machines/{nameOrId}/Desktop | Get the desktop associated with the machine, if any.
[**MachinesGetMachineMachineCatalog**](MachinesAPIs .md#MachinesGetMachineMachineCatalog) | **Get** /Machines/{nameOrId}/MachineCatalog | Get the machine catalog for a machine.
[**MachinesGetMachinePowerActionSchedules**](MachinesAPIs .md#MachinesGetMachinePowerActionSchedules) | **Get** /Machines/{nameOrId}/PowerActionSchedules | Get the power action schedules associated with a machine.
[**MachinesGetMachineSessions**](MachinesAPIs .md#MachinesGetMachineSessions) | **Get** /Machines/{nameOrId}/Sessions | Get the list of sessions running on a machine.
[**MachinesGetMachineStartMenuShortcutIcon**](MachinesAPIs .md#MachinesGetMachineStartMenuShortcutIcon) | **Get** /Machines/{nameOrId}/StartMenuShortcutIcon | Get a start menu shortcut icon from the machine.
[**MachinesGetMachineStartMenuShortcuts**](MachinesAPIs .md#MachinesGetMachineStartMenuShortcuts) | **Get** /Machines/{nameOrId}/StartMenuShortcuts | Get start menu shortcuts from the machine.
[**MachinesGetMachineTags**](MachinesAPIs .md#MachinesGetMachineTags) | **Get** /Machines/{nameOrId}/Tags | Get tags associated with a machine.
[**MachinesGetMachines**](MachinesAPIs .md#MachinesGetMachines) | **Get** /Machines | Get all machines in the site.
[**MachinesGetMachinesAdministrators**](MachinesAPIs .md#MachinesGetMachinesAdministrators) | **Get** /Machines/{nameOrId}/Administrators | Get administrators who can administer a machine
[**MachinesGetTestMachineReport**](MachinesAPIs .md#MachinesGetTestMachineReport) | **Get** /Machines/{nameOrId}/TestReports/{reportId} | Get Cloud Health Check Report on a VDA machine.
[**MachinesImportFileTypes**](MachinesAPIs .md#MachinesImportFileTypes) | **Post** /Machines/{nameOrId}/FileTypes/$import | Import file type associations from the machine.
[**MachinesLogoffMachineSessions**](MachinesAPIs .md#MachinesLogoffMachineSessions) | **Post** /Machines/{nameOrId}/$logoff | Logoff all sessions on a machine.
[**MachinesRebootMachine**](MachinesAPIs .md#MachinesRebootMachine) | **Post** /Machines/{nameOrId}/$reboot | Reboot a machine.
[**MachinesRemoveMachine**](MachinesAPIs .md#MachinesRemoveMachine) | **Delete** /Machines/{nameOrId} | Delete a machine from the site.
[**MachinesRemoveMachineTags**](MachinesAPIs .md#MachinesRemoveMachineTags) | **Delete** /Machines/{nameOrId}/Tags/{tagNameOrId} | Remove a tag from a machine.
[**MachinesRemoveMachineUpgradeSchedule**](MachinesAPIs .md#MachinesRemoveMachineUpgradeSchedule) | **Delete** /Machines/{nameOrId}/UpgradeSchedule | Remove a pending VDA upgrade schedule for a machine.
[**MachinesRemovePowerActionSchedule**](MachinesAPIs .md#MachinesRemovePowerActionSchedule) | **Delete** /Machines/{nameOrId}/PowerActionSchedules | Remove pending power action schedules for a machine.
[**MachinesResumeMachine**](MachinesAPIs .md#MachinesResumeMachine) | **Post** /Machines/{nameOrId}/$resume | Resume a machine.
[**MachinesSetMachineTags**](MachinesAPIs .md#MachinesSetMachineTags) | **Put** /Machines/{nameOrId}/Tags | Set tags associated with a machine.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.MachinesAPIs .MachinesRemovePowerActionSchedule(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).Async(async).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesRemovePowerActionSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MachinesAPIs .MachinesResumeMachine(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).DetailResponseRequired(detailResponseRequired).Async(async).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesResumeMachine``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `MachinesResumeMachine`: MachineDetailResponseModel
    fmt.Fprintf(os.Stdout, "Response from `MachinesAPIs .MachinesResumeMachine`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.MachinesAPIs .MachinesSetMachineTags(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).TagsRequestModel(tagsRequestModel).Async(async).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesSetMachineTags``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MachinesAPIs .MachinesStartMachine(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).DetailResponseRequired(detailResponseRequired).Async(async).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesStartMachine``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `MachinesStartMachine`: MachineDetailResponseModel
    fmt.Fprintf(os.Stdout, "Response from `MachinesAPIs .MachinesStartMachine`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MachinesAPIs .MachinesSuspendMachine(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).DetailResponseRequired(detailResponseRequired).Async(async).Delay(delay).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesSuspendMachine``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `MachinesSuspendMachine`: MachineDetailResponseModel
    fmt.Fprintf(os.Stdout, "Response from `MachinesAPIs .MachinesSuspendMachine`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.MachinesAPIs .MachinesUpdateMachineUpgradeSchedule(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).UpdateUpgradeScheduleRequestModel(updateUpgradeScheduleRequestModel).Async(async).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MachinesAPIs .MachinesUpdateMachineUpgradeSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
