...
------------- | ------------- | -------------
[**TenantsGetTenant**](TenantsAPIsDAAS.md#TenantsGetTenant) | **Get** /Tenants/{nameOrId} | Get a single tenant from the site.
[**TenantsGetTenantApplicationGroups**](TenantsAPIsDAAS.md#TenantsGetTenantApplicationGroups) | **Get** /Tenants/{nameOrId}/ApplicationGroups | Get application groups associated with a tenant.
[**TenantsGetTenantApplications**](TenantsAPIsDAAS.md#TenantsGetTenantApplications) | **Get** /Tenants/{nameOrId}/Applications | Get applications associated with a tenant.
[**TenantsGetTenantDeliveryGroups**](TenantsAPIsDAAS.md#TenantsGetTenantDeliveryGroups) | **Get** /Tenants/{nameOrId}/DeliveryGroups | Get delivery groups associated with a tenant.
[**TenantsGetTenantDesktops**](TenantsAPIsDAAS.md#TenantsGetTenantDesktops) | **Get** /Tenants/{nameOrId}/Desktops | Get desktops associated with a tenant.
[**TenantsGetTenantHypervisors**](TenantsAPIsDAAS.md#TenantsGetTenantHypervisors) | **Get** /Tenants/{nameOrId}/Hypervisors | Get hypervisors associated with a tenant.
[**TenantsGetTenantMachineCatalogs**](TenantsAPIsDAAS.md#TenantsGetTenantMachineCatalogs) | **Get** /Tenants/{nameOrId}/MachineCatalogs | Get machine catalogs associated with a tenant.
[**TenantsGetTenants**](TenantsAPIsDAAS.md#TenantsGetTenants) | **Get** /Tenants | Get the list of all tenants in the site.
...
func main() {
    ...
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenant(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenant``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenant`: TenantDetailResponseModel
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenant`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenantApplications(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).IncludeShared(includeShared).Limit(limit).ContinuationToken(continuationToken).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenantApplications``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenantApplications`: ApplicationResponseModelCollection
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenantApplications`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenantDeliveryGroups(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).IncludeShared(includeShared).Limit(limit).ContinuationToken(continuationToken).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenantDeliveryGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenantDeliveryGroups`: DeliveryGroupResponseModelCollection
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenantDeliveryGroups`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenantDesktops(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).IncludeShared(includeShared).Limit(limit).ContinuationToken(continuationToken).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenantDesktops``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenantDesktops`: DesktopResponseModelCollection
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenantDesktops`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenantHypervisors(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).IncludeShared(includeShared).Limit(limit).ContinuationToken(continuationToken).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenantHypervisors``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenantHypervisors`: HypervisorResponseModelCollection
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenantHypervisors`: %v\n", resp)
}
```
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TenantsAPIsDAAS.TenantsGetTenantMachineCatalogs(context.Background(), nameOrId).CitrixCustomerId(citrixCustomerId).CitrixInstanceId(citrixInstanceId).UserAgent(userAgent).IncludeShared(includeShared).Limit(limit).ContinuationToken(continuationToken).Authorization(authorization).CitrixTransactionId(citrixTransactionId).XActionName(xActionName).Accept(accept).CitrixLocale(citrixLocale).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TenantsAPIsDAAS.TenantsGetTenantMachineCatalogs``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `TenantsGetTenantMachineCatalogs`: MachineCatalogResponseModelCollection
    fmt.Fprintf(os.Stdout, "Response from `TenantsAPIsDAAS.TenantsGetTenantMachineCatalogs`: %v\n", resp)
}
```
