...
type DesktopResponseModel struct {
	...
	RestrictToTag *DesktopResponseModelRestrictToTag `json:"RestrictToTag,omitempty"`
	...
	MachinesForAssignment *int32 `json:"MachinesForAssignment,omitempty"`
...
func (o *DesktopResponseModel) GetRestrictToTag() DesktopResponseModelRestrictToTag {
	if o == nil || IsNil(o.RestrictToTag) {
		var ret DesktopResponseModelRestrictToTag
		return ret
	}
...
// SetRestrictToTag gets a reference to the given DesktopResponseModelRestrictToTag and assigns it to the RestrictToTag field.
...
// GetMachinesForAssignment returns the MachinesForAssignment field value if set, zero value otherwise.
func (o *DesktopResponseModel) GetMachinesForAssignment() int32 {
	if o == nil || IsNil(o.MachinesForAssignment) {
		var ret int32
		return ret
	}
	return *o.MachinesForAssignment
}
...
func (o *DesktopResponseModel) GetMachinesForAssignmentOk() (*int32, bool) {
	...
	return o.MachinesForAssignment, true
}
...
// SetMachinesForAssignment gets a reference to the given int32 and assigns it to the MachinesForAssignment field.
func (o *DesktopResponseModel) SetMachinesForAssignment(v int32) {
	o.MachinesForAssignment = &v
}
...
func (o DesktopResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MachinesForAssignment) {
		toSerialize["MachinesForAssignment"] = o.MachinesForAssignment
	}
	if !IsNil(o.Tenants) {
