...
// checks if the StoreFrontServerResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreFrontServerResponseModelCollection{}

// StoreFrontServerResponseModelCollection struct for StoreFrontServerResponseModelCollection
type StoreFrontServerResponseModelCollection struct {
	// List of items.
...
type _StoreFrontServerResponseModelCollection StoreFrontServerResponseModelCollection
...
func NewStoreFrontServerResponseModelCollection(items []StoreFrontServerResponseModel) *StoreFrontServerResponseModelCollection {
	this := StoreFrontServerResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *StoreFrontServerResponseModelCollection) SetContinuationTokenNil() {
...
func (o *StoreFrontServerResponseModelCollection) SetTotalItemsNil() {
...
func (o StoreFrontServerResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o StoreFrontServerResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableStoreFrontServerResponseModelCollection struct {
	value *StoreFrontServerResponseModelCollection
	isSet bool
}

func (v NullableStoreFrontServerResponseModelCollection) Get() *StoreFrontServerResponseModelCollection {
	return v.value
}

func (v *NullableStoreFrontServerResponseModelCollection) Set(val *StoreFrontServerResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreFrontServerResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreFrontServerResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreFrontServerResponseModelCollection(val *StoreFrontServerResponseModelCollection) *NullableStoreFrontServerResponseModelCollection {
	return &NullableStoreFrontServerResponseModelCollection{value: val, isSet: true}
}

func (v NullableStoreFrontServerResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreFrontServerResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
