...
// checks if the HypervisorVmValidationResponseModelHypervisorConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorVmValidationResponseModelHypervisorConnection{}

// HypervisorVmValidationResponseModelHypervisorConnection Response object for a hypervisor.
type HypervisorVmValidationResponseModelHypervisorConnection struct {
	// Id of the resource.
...
func NewHypervisorVmValidationResponseModelHypervisorConnection(connectionType HypervisorConnectionType, addresses []string, inMaintenanceMode bool, pluginId string, scopes []ScopeResponseModel, usesCloudInfrastructure bool, zone HypervisorResponseModelAllOfZone) *HypervisorVmValidationResponseModelHypervisorConnection {
	this := HypervisorVmValidationResponseModelHypervisorConnection{}
...
func (o HypervisorVmValidationResponseModelHypervisorConnection) MarshalJSON() ([]byte, error) {
...
func (o HypervisorVmValidationResponseModelHypervisorConnection) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorVmValidationResponseModelHypervisorConnection struct {
	value *HypervisorVmValidationResponseModelHypervisorConnection
	isSet bool
}

func (v NullableHypervisorVmValidationResponseModelHypervisorConnection) Get() *HypervisorVmValidationResponseModelHypervisorConnection {
	return v.value
}

func (v *NullableHypervisorVmValidationResponseModelHypervisorConnection) Set(val *HypervisorVmValidationResponseModelHypervisorConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorVmValidationResponseModelHypervisorConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorVmValidationResponseModelHypervisorConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorVmValidationResponseModelHypervisorConnection(val *HypervisorVmValidationResponseModelHypervisorConnection) *NullableHypervisorVmValidationResponseModelHypervisorConnection {
	return &NullableHypervisorVmValidationResponseModelHypervisorConnection{value: val, isSet: true}
}

func (v NullableHypervisorVmValidationResponseModelHypervisorConnection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorVmValidationResponseModelHypervisorConnection) UnmarshalJSON(src []byte) error {
	v.isSet = true
