...
// checks if the CollectionModelOfHypervisorResourceResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfHypervisorResourceResponseModel{}

// CollectionModelOfHypervisorResourceResponseModel Response object for collections of items.
type CollectionModelOfHypervisorResourceResponseModel struct {
	// List of items.
	Items []HypervisorResourceResponseModel `json:"Items"`
...
type _CollectionModelOfHypervisorResourceResponseModel CollectionModelOfHypervisorResourceResponseModel
...
func NewCollectionModelOfHypervisorResourceResponseModel(items []HypervisorResourceResponseModel) *CollectionModelOfHypervisorResourceResponseModel {
	this := CollectionModelOfHypervisorResourceResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfHypervisorResourceResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfHypervisorResourceResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfHypervisorResourceResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfHypervisorResourceResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfHypervisorResourceResponseModel struct {
	value *CollectionModelOfHypervisorResourceResponseModel
	isSet bool
}

func (v NullableCollectionModelOfHypervisorResourceResponseModel) Get() *CollectionModelOfHypervisorResourceResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfHypervisorResourceResponseModel) Set(val *CollectionModelOfHypervisorResourceResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfHypervisorResourceResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfHypervisorResourceResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfHypervisorResourceResponseModel(val *CollectionModelOfHypervisorResourceResponseModel) *NullableCollectionModelOfHypervisorResourceResponseModel {
	return &NullableCollectionModelOfHypervisorResourceResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfHypervisorResourceResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfHypervisorResourceResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
