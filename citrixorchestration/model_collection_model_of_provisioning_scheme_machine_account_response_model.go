...
// checks if the CollectionModelOfProvisioningSchemeMachineAccountResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisioningSchemeMachineAccountResponseModel{}

// CollectionModelOfProvisioningSchemeMachineAccountResponseModel Response object for collections of items.
type CollectionModelOfProvisioningSchemeMachineAccountResponseModel struct {
	// List of items.
...
type _CollectionModelOfProvisioningSchemeMachineAccountResponseModel CollectionModelOfProvisioningSchemeMachineAccountResponseModel
...
func NewCollectionModelOfProvisioningSchemeMachineAccountResponseModel(items []ProvisioningSchemeMachineAccountResponseModel) *CollectionModelOfProvisioningSchemeMachineAccountResponseModel {
	this := CollectionModelOfProvisioningSchemeMachineAccountResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisioningSchemeMachineAccountResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisioningSchemeMachineAccountResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisioningSchemeMachineAccountResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisioningSchemeMachineAccountResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel struct {
	value *CollectionModelOfProvisioningSchemeMachineAccountResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) Get() *CollectionModelOfProvisioningSchemeMachineAccountResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) Set(val *CollectionModelOfProvisioningSchemeMachineAccountResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel(val *CollectionModelOfProvisioningSchemeMachineAccountResponseModel) *NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel {
	return &NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisioningSchemeMachineAccountResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
