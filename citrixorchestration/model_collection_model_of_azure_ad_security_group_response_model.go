...
// checks if the CollectionModelOfAzureADSecurityGroupResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfAzureADSecurityGroupResponseModel{}

// CollectionModelOfAzureADSecurityGroupResponseModel Response object for collections of items.
type CollectionModelOfAzureADSecurityGroupResponseModel struct {
	// List of items.
...
type _CollectionModelOfAzureADSecurityGroupResponseModel CollectionModelOfAzureADSecurityGroupResponseModel
...
func NewCollectionModelOfAzureADSecurityGroupResponseModel(items []AzureADSecurityGroupResponseModel) *CollectionModelOfAzureADSecurityGroupResponseModel {
	this := CollectionModelOfAzureADSecurityGroupResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfAzureADSecurityGroupResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfAzureADSecurityGroupResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfAzureADSecurityGroupResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfAzureADSecurityGroupResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfAzureADSecurityGroupResponseModel struct {
	value *CollectionModelOfAzureADSecurityGroupResponseModel
	isSet bool
}

func (v NullableCollectionModelOfAzureADSecurityGroupResponseModel) Get() *CollectionModelOfAzureADSecurityGroupResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfAzureADSecurityGroupResponseModel) Set(val *CollectionModelOfAzureADSecurityGroupResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfAzureADSecurityGroupResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfAzureADSecurityGroupResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfAzureADSecurityGroupResponseModel(val *CollectionModelOfAzureADSecurityGroupResponseModel) *NullableCollectionModelOfAzureADSecurityGroupResponseModel {
	return &NullableCollectionModelOfAzureADSecurityGroupResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfAzureADSecurityGroupResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfAzureADSecurityGroupResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
