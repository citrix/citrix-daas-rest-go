...
// checks if the CollectionModelOfAdministratorResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfAdministratorResponseModel{}

// CollectionModelOfAdministratorResponseModel Response object for collections of items.
type CollectionModelOfAdministratorResponseModel struct {
	// List of items.
...
type _CollectionModelOfAdministratorResponseModel CollectionModelOfAdministratorResponseModel
...
func NewCollectionModelOfAdministratorResponseModel(items []AdministratorResponseModel) *CollectionModelOfAdministratorResponseModel {
	this := CollectionModelOfAdministratorResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfAdministratorResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfAdministratorResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfAdministratorResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfAdministratorResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfAdministratorResponseModel struct {
	value *CollectionModelOfAdministratorResponseModel
	isSet bool
}

func (v NullableCollectionModelOfAdministratorResponseModel) Get() *CollectionModelOfAdministratorResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfAdministratorResponseModel) Set(val *CollectionModelOfAdministratorResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfAdministratorResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfAdministratorResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfAdministratorResponseModel(val *CollectionModelOfAdministratorResponseModel) *NullableCollectionModelOfAdministratorResponseModel {
	return &NullableCollectionModelOfAdministratorResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfAdministratorResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfAdministratorResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
