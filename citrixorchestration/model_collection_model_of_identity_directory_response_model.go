...
// checks if the CollectionModelOfIdentityDirectoryResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfIdentityDirectoryResponseModel{}

// CollectionModelOfIdentityDirectoryResponseModel Response object for collections of items.
type CollectionModelOfIdentityDirectoryResponseModel struct {
	// List of items.
...
type _CollectionModelOfIdentityDirectoryResponseModel CollectionModelOfIdentityDirectoryResponseModel
...
func NewCollectionModelOfIdentityDirectoryResponseModel(items []IdentityDirectoryResponseModel) *CollectionModelOfIdentityDirectoryResponseModel {
	this := CollectionModelOfIdentityDirectoryResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfIdentityDirectoryResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfIdentityDirectoryResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfIdentityDirectoryResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfIdentityDirectoryResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfIdentityDirectoryResponseModel struct {
	value *CollectionModelOfIdentityDirectoryResponseModel
	isSet bool
}

func (v NullableCollectionModelOfIdentityDirectoryResponseModel) Get() *CollectionModelOfIdentityDirectoryResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfIdentityDirectoryResponseModel) Set(val *CollectionModelOfIdentityDirectoryResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfIdentityDirectoryResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfIdentityDirectoryResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfIdentityDirectoryResponseModel(val *CollectionModelOfIdentityDirectoryResponseModel) *NullableCollectionModelOfIdentityDirectoryResponseModel {
	return &NullableCollectionModelOfIdentityDirectoryResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfIdentityDirectoryResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfIdentityDirectoryResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
