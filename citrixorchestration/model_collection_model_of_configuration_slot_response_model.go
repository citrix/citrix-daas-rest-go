...
// checks if the CollectionModelOfConfigurationSlotResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfConfigurationSlotResponseModel{}

// CollectionModelOfConfigurationSlotResponseModel Response object for collections of items.
type CollectionModelOfConfigurationSlotResponseModel struct {
	// List of items.
...
type _CollectionModelOfConfigurationSlotResponseModel CollectionModelOfConfigurationSlotResponseModel
...
func NewCollectionModelOfConfigurationSlotResponseModel(items []ConfigurationSlotResponseModel) *CollectionModelOfConfigurationSlotResponseModel {
	this := CollectionModelOfConfigurationSlotResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfConfigurationSlotResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfConfigurationSlotResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfConfigurationSlotResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfConfigurationSlotResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfConfigurationSlotResponseModel struct {
	value *CollectionModelOfConfigurationSlotResponseModel
	isSet bool
}

func (v NullableCollectionModelOfConfigurationSlotResponseModel) Get() *CollectionModelOfConfigurationSlotResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfConfigurationSlotResponseModel) Set(val *CollectionModelOfConfigurationSlotResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfConfigurationSlotResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfConfigurationSlotResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfConfigurationSlotResponseModel(val *CollectionModelOfConfigurationSlotResponseModel) *NullableCollectionModelOfConfigurationSlotResponseModel {
	return &NullableCollectionModelOfConfigurationSlotResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfConfigurationSlotResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfConfigurationSlotResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
