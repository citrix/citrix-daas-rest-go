...
// checks if the CollectionModelOfApplicationGroupDeliveryGroupResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfApplicationGroupDeliveryGroupResponseModel{}

// CollectionModelOfApplicationGroupDeliveryGroupResponseModel Response object for collections of items.
type CollectionModelOfApplicationGroupDeliveryGroupResponseModel struct {
	// List of items.
...
type _CollectionModelOfApplicationGroupDeliveryGroupResponseModel CollectionModelOfApplicationGroupDeliveryGroupResponseModel
...
func NewCollectionModelOfApplicationGroupDeliveryGroupResponseModel(items []ApplicationGroupDeliveryGroupResponseModel) *CollectionModelOfApplicationGroupDeliveryGroupResponseModel {
	this := CollectionModelOfApplicationGroupDeliveryGroupResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfApplicationGroupDeliveryGroupResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfApplicationGroupDeliveryGroupResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfApplicationGroupDeliveryGroupResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfApplicationGroupDeliveryGroupResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel struct {
	value *CollectionModelOfApplicationGroupDeliveryGroupResponseModel
	isSet bool
}

func (v NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) Get() *CollectionModelOfApplicationGroupDeliveryGroupResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) Set(val *CollectionModelOfApplicationGroupDeliveryGroupResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel(val *CollectionModelOfApplicationGroupDeliveryGroupResponseModel) *NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel {
	return &NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfApplicationGroupDeliveryGroupResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
