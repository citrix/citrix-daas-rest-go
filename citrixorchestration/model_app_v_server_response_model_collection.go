...
// checks if the AppVServerResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVServerResponseModelCollection{}

// AppVServerResponseModelCollection struct for AppVServerResponseModelCollection
type AppVServerResponseModelCollection struct {
	// List of items.
...
type _AppVServerResponseModelCollection AppVServerResponseModelCollection
...
func NewAppVServerResponseModelCollection(items []AppVServerResponseModel) *AppVServerResponseModelCollection {
	this := AppVServerResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AppVServerResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AppVServerResponseModelCollection) SetTotalItemsNil() {
...
func (o AppVServerResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AppVServerResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppVServerResponseModelCollection struct {
	value *AppVServerResponseModelCollection
	isSet bool
}

func (v NullableAppVServerResponseModelCollection) Get() *AppVServerResponseModelCollection {
	return v.value
}

func (v *NullableAppVServerResponseModelCollection) Set(val *AppVServerResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVServerResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVServerResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVServerResponseModelCollection(val *AppVServerResponseModelCollection) *NullableAppVServerResponseModelCollection {
	return &NullableAppVServerResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppVServerResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVServerResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
