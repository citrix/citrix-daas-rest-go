...
// checks if the HypervisorDetailResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorDetailResponseModel{}

// HypervisorDetailResponseModel struct for HypervisorDetailResponseModel
type HypervisorDetailResponseModel struct {
...
func NewHypervisorDetailResponseModel(apiKey string, region string, applicationId string, subscriptionId string, activeDirectoryId string, environment AzureEnvironment, managementEndpoint string, authenticationAuthority string, storageSuffix string, serviceAccountId string, sccmWakeUpProxy bool, wakeOnLanPackets WakeOnLanTransmission, userName string, tenancyOcid string, ociRegion string, ociEnvironment string, fingerprint string, connectionType HypervisorConnectionType, addresses []string, inMaintenanceMode bool, pluginId string, scopes []ScopeResponseModel, usesCloudInfrastructure bool, zone HypervisorResponseModelAllOfZone, capabilities []string, configurationObjectCapabilities []HypervisorConfigurationObjectCapability, pluginRevision string, maxAbsoluteActiveActions int32, maxAbsoluteNewActionsPerMinute int32, maxPowerActionsPercentageOfMachines int32, connectionOptions string, supportsLocalStorageCaching bool, supportsPvsVms bool) *HypervisorDetailResponseModel {
	this := HypervisorDetailResponseModel{}
...
func (o HypervisorDetailResponseModel) MarshalJSON() ([]byte, error) {
...
func (o HypervisorDetailResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorDetailResponseModel struct {
	value *HypervisorDetailResponseModel
	isSet bool
}

func (v NullableHypervisorDetailResponseModel) Get() *HypervisorDetailResponseModel {
	return v.value
}

func (v *NullableHypervisorDetailResponseModel) Set(val *HypervisorDetailResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorDetailResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorDetailResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorDetailResponseModel(val *HypervisorDetailResponseModel) *NullableHypervisorDetailResponseModel {
	return &NullableHypervisorDetailResponseModel{value: val, isSet: true}
}

func (v NullableHypervisorDetailResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorDetailResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
