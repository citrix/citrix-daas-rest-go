...
// checks if the CollectionModelOfIdentityUserResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfIdentityUserResponseModel{}

// CollectionModelOfIdentityUserResponseModel Response object for collections of items.
type CollectionModelOfIdentityUserResponseModel struct {
	// List of items.
...
type _CollectionModelOfIdentityUserResponseModel CollectionModelOfIdentityUserResponseModel
...
func NewCollectionModelOfIdentityUserResponseModel(items []IdentityUserResponseModel) *CollectionModelOfIdentityUserResponseModel {
	this := CollectionModelOfIdentityUserResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfIdentityUserResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfIdentityUserResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfIdentityUserResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfIdentityUserResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfIdentityUserResponseModel struct {
	value *CollectionModelOfIdentityUserResponseModel
	isSet bool
}

func (v NullableCollectionModelOfIdentityUserResponseModel) Get() *CollectionModelOfIdentityUserResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfIdentityUserResponseModel) Set(val *CollectionModelOfIdentityUserResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfIdentityUserResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfIdentityUserResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfIdentityUserResponseModel(val *CollectionModelOfIdentityUserResponseModel) *NullableCollectionModelOfIdentityUserResponseModel {
	return &NullableCollectionModelOfIdentityUserResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfIdentityUserResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfIdentityUserResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
