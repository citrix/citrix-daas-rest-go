...
type BackupRestoreStatusResponseModel struct {
	...
	// Is this a backup retry after a failed backup
...
func NewBackupRestoreStatusResponseModel(action BackupRestoreActions, executionId string, duration int32, restApiDuration int32, status BackupRestoreStatus) *BackupRestoreStatusResponseModel {
	...
	this.RestApiDuration = restApiDuration
	this.Status = status
	return &this
}
...
// GetRestApiDuration returns the RestApiDuration field value
...
// GetRestApiDurationOk returns a tuple with the RestApiDuration field value
// and a boolean to check if the value has been set.
...
// SetRestApiDuration sets field value
