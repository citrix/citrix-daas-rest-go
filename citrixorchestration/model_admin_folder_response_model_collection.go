...
// checks if the AdminFolderResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminFolderResponseModelCollection{}

// AdminFolderResponseModelCollection struct for AdminFolderResponseModelCollection
type AdminFolderResponseModelCollection struct {
	// List of items.
...
type _AdminFolderResponseModelCollection AdminFolderResponseModelCollection
...
func NewAdminFolderResponseModelCollection(items []AdminFolderResponseModel) *AdminFolderResponseModelCollection {
	this := AdminFolderResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AdminFolderResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AdminFolderResponseModelCollection) SetTotalItemsNil() {
...
func (o AdminFolderResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AdminFolderResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAdminFolderResponseModelCollection struct {
	value *AdminFolderResponseModelCollection
	isSet bool
}

func (v NullableAdminFolderResponseModelCollection) Get() *AdminFolderResponseModelCollection {
	return v.value
}

func (v *NullableAdminFolderResponseModelCollection) Set(val *AdminFolderResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminFolderResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminFolderResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminFolderResponseModelCollection(val *AdminFolderResponseModelCollection) *NullableAdminFolderResponseModelCollection {
	return &NullableAdminFolderResponseModelCollection{value: val, isSet: true}
}

func (v NullableAdminFolderResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminFolderResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
