...
// checks if the CollectionModelOfAutoscaleGroupPluginModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfAutoscaleGroupPluginModel{}

// CollectionModelOfAutoscaleGroupPluginModel Response object for collections of items.
type CollectionModelOfAutoscaleGroupPluginModel struct {
	// List of items.
	Items []AutoscaleGroupPluginModel `json:"Items"`
...
type _CollectionModelOfAutoscaleGroupPluginModel CollectionModelOfAutoscaleGroupPluginModel
...
func NewCollectionModelOfAutoscaleGroupPluginModel(items []AutoscaleGroupPluginModel) *CollectionModelOfAutoscaleGroupPluginModel {
	this := CollectionModelOfAutoscaleGroupPluginModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfAutoscaleGroupPluginModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfAutoscaleGroupPluginModel) SetTotalItemsNil() {
...
func (o CollectionModelOfAutoscaleGroupPluginModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfAutoscaleGroupPluginModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfAutoscaleGroupPluginModel struct {
	value *CollectionModelOfAutoscaleGroupPluginModel
	isSet bool
}

func (v NullableCollectionModelOfAutoscaleGroupPluginModel) Get() *CollectionModelOfAutoscaleGroupPluginModel {
	return v.value
}

func (v *NullableCollectionModelOfAutoscaleGroupPluginModel) Set(val *CollectionModelOfAutoscaleGroupPluginModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfAutoscaleGroupPluginModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfAutoscaleGroupPluginModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfAutoscaleGroupPluginModel(val *CollectionModelOfAutoscaleGroupPluginModel) *NullableCollectionModelOfAutoscaleGroupPluginModel {
	return &NullableCollectionModelOfAutoscaleGroupPluginModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfAutoscaleGroupPluginModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfAutoscaleGroupPluginModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
