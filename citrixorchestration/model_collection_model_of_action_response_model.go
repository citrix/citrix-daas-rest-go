...
// checks if the CollectionModelOfActionResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfActionResponseModel{}

// CollectionModelOfActionResponseModel Response object for collections of items.
type CollectionModelOfActionResponseModel struct {
	// List of items.
...
type _CollectionModelOfActionResponseModel CollectionModelOfActionResponseModel
...
func NewCollectionModelOfActionResponseModel(items []ActionResponseModel) *CollectionModelOfActionResponseModel {
	this := CollectionModelOfActionResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfActionResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfActionResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfActionResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfActionResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfActionResponseModel struct {
	value *CollectionModelOfActionResponseModel
	isSet bool
}

func (v NullableCollectionModelOfActionResponseModel) Get() *CollectionModelOfActionResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfActionResponseModel) Set(val *CollectionModelOfActionResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfActionResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfActionResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfActionResponseModel(val *CollectionModelOfActionResponseModel) *NullableCollectionModelOfActionResponseModel {
	return &NullableCollectionModelOfActionResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfActionResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfActionResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
