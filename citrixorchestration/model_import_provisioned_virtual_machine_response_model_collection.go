...
// checks if the ImportProvisionedVirtualMachineResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportProvisionedVirtualMachineResponseModelCollection{}

// ImportProvisionedVirtualMachineResponseModelCollection struct for ImportProvisionedVirtualMachineResponseModelCollection
type ImportProvisionedVirtualMachineResponseModelCollection struct {
	// List of items.
...
type _ImportProvisionedVirtualMachineResponseModelCollection ImportProvisionedVirtualMachineResponseModelCollection
...
func NewImportProvisionedVirtualMachineResponseModelCollection(items []ImportProvisionedVirtualMachineResponseModel) *ImportProvisionedVirtualMachineResponseModelCollection {
	this := ImportProvisionedVirtualMachineResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ImportProvisionedVirtualMachineResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ImportProvisionedVirtualMachineResponseModelCollection) SetTotalItemsNil() {
...
func (o ImportProvisionedVirtualMachineResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ImportProvisionedVirtualMachineResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableImportProvisionedVirtualMachineResponseModelCollection struct {
	value *ImportProvisionedVirtualMachineResponseModelCollection
	isSet bool
}

func (v NullableImportProvisionedVirtualMachineResponseModelCollection) Get() *ImportProvisionedVirtualMachineResponseModelCollection {
	return v.value
}

func (v *NullableImportProvisionedVirtualMachineResponseModelCollection) Set(val *ImportProvisionedVirtualMachineResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableImportProvisionedVirtualMachineResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableImportProvisionedVirtualMachineResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportProvisionedVirtualMachineResponseModelCollection(val *ImportProvisionedVirtualMachineResponseModelCollection) *NullableImportProvisionedVirtualMachineResponseModelCollection {
	return &NullableImportProvisionedVirtualMachineResponseModelCollection{value: val, isSet: true}
}

func (v NullableImportProvisionedVirtualMachineResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportProvisionedVirtualMachineResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
