...
type TestComponentResultDetailModel struct {
	...
	// The details items of the problem.
	ExplanationParametersStr NullableString `json:"ExplanationParametersStr,omitempty"`
...
// GetExplanationParametersStr returns the ExplanationParametersStr field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TestComponentResultDetailModel) GetExplanationParametersStr() string {
	if o == nil || IsNil(o.ExplanationParametersStr.Get()) {
		var ret string
		return ret
	}
	return *o.ExplanationParametersStr.Get()
}

// GetExplanationParametersStrOk returns a tuple with the ExplanationParametersStr field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TestComponentResultDetailModel) GetExplanationParametersStrOk() (*string, bool) {
	...
	return o.ExplanationParametersStr.Get(), o.ExplanationParametersStr.IsSet()
}
...
func (o *TestComponentResultDetailModel) HasExplanationParametersStr() bool {
	if o != nil && o.ExplanationParametersStr.IsSet() {
		return true
	}
...
// SetExplanationParametersStr gets a reference to the given NullableString and assigns it to the ExplanationParametersStr field.
...
func (o *TestComponentResultDetailModel) UnsetExplanationParametersStr() {
	o.ExplanationParametersStr.Unset()
}
...
func (o TestComponentResultDetailModel) ToMap() (map[string]interface{}, error) {
	...
	if o.ExplanationParametersStr.IsSet() {
		toSerialize["ExplanationParametersStr"] = o.ExplanationParametersStr.Get()
	}
	if o.Action.IsSet() {
