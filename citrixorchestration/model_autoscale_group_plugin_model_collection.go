...
// checks if the AutoscaleGroupPluginModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoscaleGroupPluginModelCollection{}

// AutoscaleGroupPluginModelCollection struct for AutoscaleGroupPluginModelCollection
type AutoscaleGroupPluginModelCollection struct {
	// List of items.
...
type _AutoscaleGroupPluginModelCollection AutoscaleGroupPluginModelCollection
...
func NewAutoscaleGroupPluginModelCollection(items []AutoscaleGroupPluginModel) *AutoscaleGroupPluginModelCollection {
	this := AutoscaleGroupPluginModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AutoscaleGroupPluginModelCollection) SetContinuationTokenNil() {
...
func (o *AutoscaleGroupPluginModelCollection) SetTotalItemsNil() {
...
func (o AutoscaleGroupPluginModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AutoscaleGroupPluginModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAutoscaleGroupPluginModelCollection struct {
	value *AutoscaleGroupPluginModelCollection
	isSet bool
}

func (v NullableAutoscaleGroupPluginModelCollection) Get() *AutoscaleGroupPluginModelCollection {
	return v.value
}

func (v *NullableAutoscaleGroupPluginModelCollection) Set(val *AutoscaleGroupPluginModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoscaleGroupPluginModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoscaleGroupPluginModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoscaleGroupPluginModelCollection(val *AutoscaleGroupPluginModelCollection) *NullableAutoscaleGroupPluginModelCollection {
	return &NullableAutoscaleGroupPluginModelCollection{value: val, isSet: true}
}

func (v NullableAutoscaleGroupPluginModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoscaleGroupPluginModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
