...
// checks if the AppLibPackageDiscoveryProfileResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppLibPackageDiscoveryProfileResponseModelCollection{}

// AppLibPackageDiscoveryProfileResponseModelCollection struct for AppLibPackageDiscoveryProfileResponseModelCollection
type AppLibPackageDiscoveryProfileResponseModelCollection struct {
	// List of items.
...
type _AppLibPackageDiscoveryProfileResponseModelCollection AppLibPackageDiscoveryProfileResponseModelCollection
...
func NewAppLibPackageDiscoveryProfileResponseModelCollection(items []AppLibPackageDiscoveryProfileResponseModel) *AppLibPackageDiscoveryProfileResponseModelCollection {
	this := AppLibPackageDiscoveryProfileResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o AppLibPackageDiscoveryProfileResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppLibPackageDiscoveryProfileResponseModelCollection struct {
	value *AppLibPackageDiscoveryProfileResponseModelCollection
	isSet bool
}

func (v NullableAppLibPackageDiscoveryProfileResponseModelCollection) Get() *AppLibPackageDiscoveryProfileResponseModelCollection {
	return v.value
}

func (v *NullableAppLibPackageDiscoveryProfileResponseModelCollection) Set(val *AppLibPackageDiscoveryProfileResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppLibPackageDiscoveryProfileResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppLibPackageDiscoveryProfileResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppLibPackageDiscoveryProfileResponseModelCollection(val *AppLibPackageDiscoveryProfileResponseModelCollection) *NullableAppLibPackageDiscoveryProfileResponseModelCollection {
	return &NullableAppLibPackageDiscoveryProfileResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppLibPackageDiscoveryProfileResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppLibPackageDiscoveryProfileResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
