...
// checks if the ProvisionedVirtualMachineSearchResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisionedVirtualMachineSearchResponseModelCollection{}

// ProvisionedVirtualMachineSearchResponseModelCollection struct for ProvisionedVirtualMachineSearchResponseModelCollection
type ProvisionedVirtualMachineSearchResponseModelCollection struct {
	// List of items.
...
type _ProvisionedVirtualMachineSearchResponseModelCollection ProvisionedVirtualMachineSearchResponseModelCollection
...
func NewProvisionedVirtualMachineSearchResponseModelCollection(items []ProvisionedVirtualMachineSearchResponseModel) *ProvisionedVirtualMachineSearchResponseModelCollection {
	this := ProvisionedVirtualMachineSearchResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ProvisionedVirtualMachineSearchResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ProvisionedVirtualMachineSearchResponseModelCollection) SetTotalItemsNil() {
...
func (o ProvisionedVirtualMachineSearchResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ProvisionedVirtualMachineSearchResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableProvisionedVirtualMachineSearchResponseModelCollection struct {
	value *ProvisionedVirtualMachineSearchResponseModelCollection
	isSet bool
}

func (v NullableProvisionedVirtualMachineSearchResponseModelCollection) Get() *ProvisionedVirtualMachineSearchResponseModelCollection {
	return v.value
}

func (v *NullableProvisionedVirtualMachineSearchResponseModelCollection) Set(val *ProvisionedVirtualMachineSearchResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableProvisionedVirtualMachineSearchResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableProvisionedVirtualMachineSearchResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvisionedVirtualMachineSearchResponseModelCollection(val *ProvisionedVirtualMachineSearchResponseModelCollection) *NullableProvisionedVirtualMachineSearchResponseModelCollection {
	return &NullableProvisionedVirtualMachineSearchResponseModelCollection{value: val, isSet: true}
}

func (v NullableProvisionedVirtualMachineSearchResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvisionedVirtualMachineSearchResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
