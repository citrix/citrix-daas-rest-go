...
// GetInstalledComponents returns the InstalledComponents field value if set, zero value otherwise.
...
// GetAvailableComponents returns the AvailableComponents field value if set, zero value otherwise.
...
// GetAvailableFeatures returns the AvailableFeatures field value if set, zero value otherwise.
