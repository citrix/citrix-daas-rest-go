...
// checks if the PredefinedPermissionResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PredefinedPermissionResponseModelCollection{}

// PredefinedPermissionResponseModelCollection struct for PredefinedPermissionResponseModelCollection
type PredefinedPermissionResponseModelCollection struct {
	// List of items.
...
type _PredefinedPermissionResponseModelCollection PredefinedPermissionResponseModelCollection
...
func NewPredefinedPermissionResponseModelCollection(items []PredefinedPermissionResponseModel) *PredefinedPermissionResponseModelCollection {
	this := PredefinedPermissionResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PredefinedPermissionResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PredefinedPermissionResponseModelCollection) SetTotalItemsNil() {
...
func (o PredefinedPermissionResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PredefinedPermissionResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePredefinedPermissionResponseModelCollection struct {
	value *PredefinedPermissionResponseModelCollection
	isSet bool
}

func (v NullablePredefinedPermissionResponseModelCollection) Get() *PredefinedPermissionResponseModelCollection {
	return v.value
}

func (v *NullablePredefinedPermissionResponseModelCollection) Set(val *PredefinedPermissionResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePredefinedPermissionResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePredefinedPermissionResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePredefinedPermissionResponseModelCollection(val *PredefinedPermissionResponseModelCollection) *NullablePredefinedPermissionResponseModelCollection {
	return &NullablePredefinedPermissionResponseModelCollection{value: val, isSet: true}
}

func (v NullablePredefinedPermissionResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePredefinedPermissionResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
