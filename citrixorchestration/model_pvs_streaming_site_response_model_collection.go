...
// checks if the PvsStreamingSiteResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PvsStreamingSiteResponseModelCollection{}

// PvsStreamingSiteResponseModelCollection struct for PvsStreamingSiteResponseModelCollection
type PvsStreamingSiteResponseModelCollection struct {
	// List of items.
...
type _PvsStreamingSiteResponseModelCollection PvsStreamingSiteResponseModelCollection
...
func NewPvsStreamingSiteResponseModelCollection(items []PvsStreamingSiteResponseModel) *PvsStreamingSiteResponseModelCollection {
	this := PvsStreamingSiteResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PvsStreamingSiteResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PvsStreamingSiteResponseModelCollection) SetTotalItemsNil() {
...
func (o PvsStreamingSiteResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PvsStreamingSiteResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePvsStreamingSiteResponseModelCollection struct {
	value *PvsStreamingSiteResponseModelCollection
	isSet bool
}

func (v NullablePvsStreamingSiteResponseModelCollection) Get() *PvsStreamingSiteResponseModelCollection {
	return v.value
}

func (v *NullablePvsStreamingSiteResponseModelCollection) Set(val *PvsStreamingSiteResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePvsStreamingSiteResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePvsStreamingSiteResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePvsStreamingSiteResponseModelCollection(val *PvsStreamingSiteResponseModelCollection) *NullablePvsStreamingSiteResponseModelCollection {
	return &NullablePvsStreamingSiteResponseModelCollection{value: val, isSet: true}
}

func (v NullablePvsStreamingSiteResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePvsStreamingSiteResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
