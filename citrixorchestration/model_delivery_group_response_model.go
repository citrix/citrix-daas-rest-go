...
func (o DeliveryGroupResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableDeliveryGroupResponseModel struct {
	value *DeliveryGroupResponseModel
	isSet bool
}

func (v NullableDeliveryGroupResponseModel) Get() *DeliveryGroupResponseModel {
	return v.value
}

func (v *NullableDeliveryGroupResponseModel) Set(val *DeliveryGroupResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliveryGroupResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableDeliveryGroupResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeliveryGroupResponseModel(val *DeliveryGroupResponseModel) *NullableDeliveryGroupResponseModel {
	return &NullableDeliveryGroupResponseModel{value: val, isSet: true}
}

func (v NullableDeliveryGroupResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeliveryGroupResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
