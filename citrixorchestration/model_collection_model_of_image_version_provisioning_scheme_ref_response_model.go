...
// checks if the CollectionModelOfImageVersionProvisioningSchemeRefResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfImageVersionProvisioningSchemeRefResponseModel{}

// CollectionModelOfImageVersionProvisioningSchemeRefResponseModel Response object for collections of items.
type CollectionModelOfImageVersionProvisioningSchemeRefResponseModel struct {
	// List of items.
	Items []ImageVersionProvisioningSchemeRefResponseModel `json:"Items"`
...
type _CollectionModelOfImageVersionProvisioningSchemeRefResponseModel CollectionModelOfImageVersionProvisioningSchemeRefResponseModel
...
func NewCollectionModelOfImageVersionProvisioningSchemeRefResponseModel(items []ImageVersionProvisioningSchemeRefResponseModel) *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel {
	this := CollectionModelOfImageVersionProvisioningSchemeRefResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) GetItems() []ImageVersionProvisioningSchemeRefResponseModel {
	if o == nil {
		var ret []ImageVersionProvisioningSchemeRefResponseModel
		return ret
	}
...
func (o *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel struct {
	value *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel
	isSet bool
}

func (v NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) Get() *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) Set(val *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel(val *CollectionModelOfImageVersionProvisioningSchemeRefResponseModel) *NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel {
	return &NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfImageVersionProvisioningSchemeRefResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
