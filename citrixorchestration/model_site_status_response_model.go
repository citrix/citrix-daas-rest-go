...
type SiteStatusResponseModel struct {
	...
	LatestControllerVersion *string `json:"LatestControllerVersion,omitempty"`
...
// GetUpgradedControllers returns the UpgradedControllers field value if set, zero value otherwise.
...
// GetControllersRequiringBinaryUpgrade returns the ControllersRequiringBinaryUpgrade field value if set, zero value otherwise.
...
// GetLatestControllerVersion returns the LatestControllerVersion field value if set, zero value otherwise.
func (o *SiteStatusResponseModel) GetLatestControllerVersion() string {
	if o == nil || IsNil(o.LatestControllerVersion) {
		var ret string
		return ret
	}
	return *o.LatestControllerVersion
}
...
func (o *SiteStatusResponseModel) GetLatestControllerVersionOk() (*string, bool) {
	...
	return o.LatestControllerVersion, true
}
...
// SetLatestControllerVersion gets a reference to the given string and assigns it to the LatestControllerVersion field.
func (o *SiteStatusResponseModel) SetLatestControllerVersion(v string) {
	o.LatestControllerVersion = &v
}

// GetDatabaseServersRequiringUpgrade returns the DatabaseServersRequiringUpgrade field value if set, zero value otherwise.
...
// GetDataStoresRequiringUpgrade returns the DataStoresRequiringUpgrade field value if set, zero value otherwise.
...
func (o SiteStatusResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UpgradedControllers) {
		toSerialize["UpgradedControllers"] = o.UpgradedControllers
	}
	if !IsNil(o.ControllersRequiringBinaryUpgrade) {
		toSerialize["ControllersRequiringBinaryUpgrade"] = o.ControllersRequiringBinaryUpgrade
	}
	if !IsNil(o.LatestControllerVersion) {
		toSerialize["LatestControllerVersion"] = o.LatestControllerVersion
	}
	if !IsNil(o.DatabaseServersRequiringUpgrade) {
		toSerialize["DatabaseServersRequiringUpgrade"] = o.DatabaseServersRequiringUpgrade
	}
	if !IsNil(o.DataStoresRequiringUpgrade) {
