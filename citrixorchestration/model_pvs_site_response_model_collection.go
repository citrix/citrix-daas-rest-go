...
// checks if the PvsSiteResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PvsSiteResponseModelCollection{}

// PvsSiteResponseModelCollection struct for PvsSiteResponseModelCollection
type PvsSiteResponseModelCollection struct {
	// List of items.
...
type _PvsSiteResponseModelCollection PvsSiteResponseModelCollection
...
func NewPvsSiteResponseModelCollection(items []PvsSiteResponseModel) *PvsSiteResponseModelCollection {
	this := PvsSiteResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PvsSiteResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PvsSiteResponseModelCollection) SetTotalItemsNil() {
...
func (o PvsSiteResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PvsSiteResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePvsSiteResponseModelCollection struct {
	value *PvsSiteResponseModelCollection
	isSet bool
}

func (v NullablePvsSiteResponseModelCollection) Get() *PvsSiteResponseModelCollection {
	return v.value
}

func (v *NullablePvsSiteResponseModelCollection) Set(val *PvsSiteResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePvsSiteResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePvsSiteResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePvsSiteResponseModelCollection(val *PvsSiteResponseModelCollection) *NullablePvsSiteResponseModelCollection {
	return &NullablePvsSiteResponseModelCollection{value: val, isSet: true}
}

func (v NullablePvsSiteResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePvsSiteResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
