...
// checks if the ImageDefinitionResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageDefinitionResponseModelCollection{}

// ImageDefinitionResponseModelCollection struct for ImageDefinitionResponseModelCollection
type ImageDefinitionResponseModelCollection struct {
	// List of items.
...
type _ImageDefinitionResponseModelCollection ImageDefinitionResponseModelCollection
...
func NewImageDefinitionResponseModelCollection(items []ImageDefinitionResponseModel) *ImageDefinitionResponseModelCollection {
	this := ImageDefinitionResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ImageDefinitionResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ImageDefinitionResponseModelCollection) SetTotalItemsNil() {
...
func (o ImageDefinitionResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ImageDefinitionResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableImageDefinitionResponseModelCollection struct {
	value *ImageDefinitionResponseModelCollection
	isSet bool
}

func (v NullableImageDefinitionResponseModelCollection) Get() *ImageDefinitionResponseModelCollection {
	return v.value
}

func (v *NullableImageDefinitionResponseModelCollection) Set(val *ImageDefinitionResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableImageDefinitionResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableImageDefinitionResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageDefinitionResponseModelCollection(val *ImageDefinitionResponseModelCollection) *NullableImageDefinitionResponseModelCollection {
	return &NullableImageDefinitionResponseModelCollection{value: val, isSet: true}
}

func (v NullableImageDefinitionResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageDefinitionResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
