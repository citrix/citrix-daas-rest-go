...
// checks if the MaintenanceCycleVMOperationJobResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceCycleVMOperationJobResponseModelCollection{}

// MaintenanceCycleVMOperationJobResponseModelCollection struct for MaintenanceCycleVMOperationJobResponseModelCollection
type MaintenanceCycleVMOperationJobResponseModelCollection struct {
	// List of items.
...
type _MaintenanceCycleVMOperationJobResponseModelCollection MaintenanceCycleVMOperationJobResponseModelCollection
...
func NewMaintenanceCycleVMOperationJobResponseModelCollection(items []MaintenanceCycleVMOperationJobResponseModel) *MaintenanceCycleVMOperationJobResponseModelCollection {
	this := MaintenanceCycleVMOperationJobResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *MaintenanceCycleVMOperationJobResponseModelCollection) SetContinuationTokenNil() {
...
func (o *MaintenanceCycleVMOperationJobResponseModelCollection) SetTotalItemsNil() {
...
func (o MaintenanceCycleVMOperationJobResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o MaintenanceCycleVMOperationJobResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableMaintenanceCycleVMOperationJobResponseModelCollection struct {
	value *MaintenanceCycleVMOperationJobResponseModelCollection
	isSet bool
}

func (v NullableMaintenanceCycleVMOperationJobResponseModelCollection) Get() *MaintenanceCycleVMOperationJobResponseModelCollection {
	return v.value
}

func (v *NullableMaintenanceCycleVMOperationJobResponseModelCollection) Set(val *MaintenanceCycleVMOperationJobResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceCycleVMOperationJobResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceCycleVMOperationJobResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceCycleVMOperationJobResponseModelCollection(val *MaintenanceCycleVMOperationJobResponseModelCollection) *NullableMaintenanceCycleVMOperationJobResponseModelCollection {
	return &NullableMaintenanceCycleVMOperationJobResponseModelCollection{value: val, isSet: true}
}

func (v NullableMaintenanceCycleVMOperationJobResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceCycleVMOperationJobResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
