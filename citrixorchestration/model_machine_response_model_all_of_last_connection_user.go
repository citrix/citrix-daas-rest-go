...
// checks if the MachineResponseModelAllOfLastConnectionUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MachineResponseModelAllOfLastConnectionUser{}

// MachineResponseModelAllOfLastConnectionUser The user that last attempted a connection with the machine.
type MachineResponseModelAllOfLastConnectionUser struct {
...
func NewMachineResponseModelAllOfLastConnectionUser(displayName string, propertiesFetched int32) *MachineResponseModelAllOfLastConnectionUser {
	this := MachineResponseModelAllOfLastConnectionUser{}
...
func (o MachineResponseModelAllOfLastConnectionUser) MarshalJSON() ([]byte, error) {
...
func (o MachineResponseModelAllOfLastConnectionUser) ToMap() (map[string]interface{}, error) {
...
type NullableMachineResponseModelAllOfLastConnectionUser struct {
	value *MachineResponseModelAllOfLastConnectionUser
	isSet bool
}

func (v NullableMachineResponseModelAllOfLastConnectionUser) Get() *MachineResponseModelAllOfLastConnectionUser {
	return v.value
}

func (v *NullableMachineResponseModelAllOfLastConnectionUser) Set(val *MachineResponseModelAllOfLastConnectionUser) {
	v.value = val
	v.isSet = true
}

func (v NullableMachineResponseModelAllOfLastConnectionUser) IsSet() bool {
	return v.isSet
}

func (v *NullableMachineResponseModelAllOfLastConnectionUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMachineResponseModelAllOfLastConnectionUser(val *MachineResponseModelAllOfLastConnectionUser) *NullableMachineResponseModelAllOfLastConnectionUser {
	return &NullableMachineResponseModelAllOfLastConnectionUser{value: val, isSet: true}
}

func (v NullableMachineResponseModelAllOfLastConnectionUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMachineResponseModelAllOfLastConnectionUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
