...
// checks if the AppVApplicationResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVApplicationResponseModelCollection{}

// AppVApplicationResponseModelCollection struct for AppVApplicationResponseModelCollection
type AppVApplicationResponseModelCollection struct {
	// List of items.
...
type _AppVApplicationResponseModelCollection AppVApplicationResponseModelCollection
...
func NewAppVApplicationResponseModelCollection(items []AppVApplicationResponseModel) *AppVApplicationResponseModelCollection {
	this := AppVApplicationResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AppVApplicationResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AppVApplicationResponseModelCollection) SetTotalItemsNil() {
...
func (o AppVApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AppVApplicationResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppVApplicationResponseModelCollection struct {
	value *AppVApplicationResponseModelCollection
	isSet bool
}

func (v NullableAppVApplicationResponseModelCollection) Get() *AppVApplicationResponseModelCollection {
	return v.value
}

func (v *NullableAppVApplicationResponseModelCollection) Set(val *AppVApplicationResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVApplicationResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVApplicationResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVApplicationResponseModelCollection(val *AppVApplicationResponseModelCollection) *NullableAppVApplicationResponseModelCollection {
	return &NullableAppVApplicationResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppVApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVApplicationResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
