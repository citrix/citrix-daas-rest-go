...
// checks if the PvsStreamingStoreResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PvsStreamingStoreResponseModelCollection{}

// PvsStreamingStoreResponseModelCollection struct for PvsStreamingStoreResponseModelCollection
type PvsStreamingStoreResponseModelCollection struct {
	// List of items.
...
type _PvsStreamingStoreResponseModelCollection PvsStreamingStoreResponseModelCollection
...
func NewPvsStreamingStoreResponseModelCollection(items []PvsStreamingStoreResponseModel) *PvsStreamingStoreResponseModelCollection {
	this := PvsStreamingStoreResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PvsStreamingStoreResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PvsStreamingStoreResponseModelCollection) SetTotalItemsNil() {
...
func (o PvsStreamingStoreResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PvsStreamingStoreResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePvsStreamingStoreResponseModelCollection struct {
	value *PvsStreamingStoreResponseModelCollection
	isSet bool
}

func (v NullablePvsStreamingStoreResponseModelCollection) Get() *PvsStreamingStoreResponseModelCollection {
	return v.value
}

func (v *NullablePvsStreamingStoreResponseModelCollection) Set(val *PvsStreamingStoreResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePvsStreamingStoreResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePvsStreamingStoreResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePvsStreamingStoreResponseModelCollection(val *PvsStreamingStoreResponseModelCollection) *NullablePvsStreamingStoreResponseModelCollection {
	return &NullablePvsStreamingStoreResponseModelCollection{value: val, isSet: true}
}

func (v NullablePvsStreamingStoreResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePvsStreamingStoreResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
