...
// checks if the DailyCostResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DailyCostResponseModelCollection{}

// DailyCostResponseModelCollection struct for DailyCostResponseModelCollection
type DailyCostResponseModelCollection struct {
	// List of items.
...
type _DailyCostResponseModelCollection DailyCostResponseModelCollection
...
func NewDailyCostResponseModelCollection(items []DailyCostItemResponseModel) *DailyCostResponseModelCollection {
	this := DailyCostResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *DailyCostResponseModelCollection) SetContinuationTokenNil() {
...
func (o *DailyCostResponseModelCollection) SetTotalItemsNil() {
...
func (o DailyCostResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o DailyCostResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableDailyCostResponseModelCollection struct {
	value *DailyCostResponseModelCollection
	isSet bool
}

func (v NullableDailyCostResponseModelCollection) Get() *DailyCostResponseModelCollection {
	return v.value
}

func (v *NullableDailyCostResponseModelCollection) Set(val *DailyCostResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableDailyCostResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableDailyCostResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDailyCostResponseModelCollection(val *DailyCostResponseModelCollection) *NullableDailyCostResponseModelCollection {
	return &NullableDailyCostResponseModelCollection{value: val, isSet: true}
}

func (v NullableDailyCostResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDailyCostResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
