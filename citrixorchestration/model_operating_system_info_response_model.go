...
// SetReleaseId gets a reference to the given NullableString and assigns it to the ReleaseId field.
...
func (o *OperatingSystemInfoResponseModel) SetReleaseIdNil() {
	o.ReleaseId.Set(nil)
}
...
// GetUpdateBuildRevision returns the UpdateBuildRevision field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OperatingSystemInfoResponseModel) GetUpdateBuildRevision() string {
	if o == nil || IsNil(o.UpdateBuildRevision.Get()) {
		var ret string
		return ret
	}
	return *o.UpdateBuildRevision.Get()
}
...
func (o *OperatingSystemInfoResponseModel) GetUpdateBuildRevisionOk() (*string, bool) {
	...
	return o.UpdateBuildRevision.Get(), o.UpdateBuildRevision.IsSet()
}
...
func (o *OperatingSystemInfoResponseModel) HasUpdateBuildRevision() bool {
	if o != nil && o.UpdateBuildRevision.IsSet() {
		return true
	}
...
// SetUpdateBuildRevision gets a reference to the given NullableString and assigns it to the UpdateBuildRevision field.
func (o *OperatingSystemInfoResponseModel) SetUpdateBuildRevision(v string) {
	o.UpdateBuildRevision.Set(&v)
}
// SetUpdateBuildRevisionNil sets the value for UpdateBuildRevision to be an explicit nil
func (o *OperatingSystemInfoResponseModel) SetUpdateBuildRevisionNil() {
	o.UpdateBuildRevision.Set(nil)
}
...
func (o *OperatingSystemInfoResponseModel) UnsetUpdateBuildRevision() {
	o.UpdateBuildRevision.Unset()
}

// GetDisplayVersion returns the DisplayVersion field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OperatingSystemInfoResponseModel) GetDisplayVersion() string {
	if o == nil || IsNil(o.DisplayVersion.Get()) {
		var ret string
		return ret
	}
	return *o.DisplayVersion.Get()
}
...
func (o *OperatingSystemInfoResponseModel) GetDisplayVersionOk() (*string, bool) {
	...
	return o.DisplayVersion.Get(), o.DisplayVersion.IsSet()
}
...
func (o *OperatingSystemInfoResponseModel) HasDisplayVersion() bool {
	if o != nil && o.DisplayVersion.IsSet() {
		return true
	}
...
// SetDisplayVersion gets a reference to the given NullableString and assigns it to the DisplayVersion field.
func (o *OperatingSystemInfoResponseModel) SetDisplayVersion(v string) {
	o.DisplayVersion.Set(&v)
}
// SetDisplayVersionNil sets the value for DisplayVersion to be an explicit nil
func (o *OperatingSystemInfoResponseModel) SetDisplayVersionNil() {
	o.DisplayVersion.Set(nil)
}
...
func (o OperatingSystemInfoResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if o.UpdateBuildRevision.IsSet() {
		toSerialize["UpdateBuildRevision"] = o.UpdateBuildRevision.Get()
	}
	if o.DisplayVersion.IsSet() {
		toSerialize["DisplayVersion"] = o.DisplayVersion.Get()
	}
