...
// checks if the HypervisorResourcePoolNetworkResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolNetworkResponseModelCollection{}

// HypervisorResourcePoolNetworkResponseModelCollection struct for HypervisorResourcePoolNetworkResponseModelCollection
type HypervisorResourcePoolNetworkResponseModelCollection struct {
	// List of items.
...
type _HypervisorResourcePoolNetworkResponseModelCollection HypervisorResourcePoolNetworkResponseModelCollection
...
func NewHypervisorResourcePoolNetworkResponseModelCollection(items []HypervisorResourcePoolNetworkResponseModel) *HypervisorResourcePoolNetworkResponseModelCollection {
	this := HypervisorResourcePoolNetworkResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *HypervisorResourcePoolNetworkResponseModelCollection) SetContinuationTokenNil() {
...
func (o *HypervisorResourcePoolNetworkResponseModelCollection) SetTotalItemsNil() {
...
func (o HypervisorResourcePoolNetworkResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolNetworkResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolNetworkResponseModelCollection struct {
	value *HypervisorResourcePoolNetworkResponseModelCollection
	isSet bool
}

func (v NullableHypervisorResourcePoolNetworkResponseModelCollection) Get() *HypervisorResourcePoolNetworkResponseModelCollection {
	return v.value
}

func (v *NullableHypervisorResourcePoolNetworkResponseModelCollection) Set(val *HypervisorResourcePoolNetworkResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolNetworkResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolNetworkResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolNetworkResponseModelCollection(val *HypervisorResourcePoolNetworkResponseModelCollection) *NullableHypervisorResourcePoolNetworkResponseModelCollection {
	return &NullableHypervisorResourcePoolNetworkResponseModelCollection{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolNetworkResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolNetworkResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
