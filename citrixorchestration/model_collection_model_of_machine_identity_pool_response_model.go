...
// checks if the CollectionModelOfMachineIdentityPoolResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfMachineIdentityPoolResponseModel{}

// CollectionModelOfMachineIdentityPoolResponseModel Response object for collections of items.
type CollectionModelOfMachineIdentityPoolResponseModel struct {
	// List of items.
...
type _CollectionModelOfMachineIdentityPoolResponseModel CollectionModelOfMachineIdentityPoolResponseModel
...
func NewCollectionModelOfMachineIdentityPoolResponseModel(items []MachineIdentityPoolResponseModel) *CollectionModelOfMachineIdentityPoolResponseModel {
	this := CollectionModelOfMachineIdentityPoolResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfMachineIdentityPoolResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfMachineIdentityPoolResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfMachineIdentityPoolResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfMachineIdentityPoolResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfMachineIdentityPoolResponseModel struct {
	value *CollectionModelOfMachineIdentityPoolResponseModel
	isSet bool
}

func (v NullableCollectionModelOfMachineIdentityPoolResponseModel) Get() *CollectionModelOfMachineIdentityPoolResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfMachineIdentityPoolResponseModel) Set(val *CollectionModelOfMachineIdentityPoolResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfMachineIdentityPoolResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfMachineIdentityPoolResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfMachineIdentityPoolResponseModel(val *CollectionModelOfMachineIdentityPoolResponseModel) *NullableCollectionModelOfMachineIdentityPoolResponseModel {
	return &NullableCollectionModelOfMachineIdentityPoolResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfMachineIdentityPoolResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfMachineIdentityPoolResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
