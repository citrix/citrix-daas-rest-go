...
// checks if the CollectionModelOfResourceCostItemResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfResourceCostItemResponseModel{}

// CollectionModelOfResourceCostItemResponseModel Response object for collections of items.
type CollectionModelOfResourceCostItemResponseModel struct {
	// List of items.
	Items []ResourceCostItemResponseModel `json:"Items"`
...
type _CollectionModelOfResourceCostItemResponseModel CollectionModelOfResourceCostItemResponseModel
...
func NewCollectionModelOfResourceCostItemResponseModel(items []ResourceCostItemResponseModel) *CollectionModelOfResourceCostItemResponseModel {
	this := CollectionModelOfResourceCostItemResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfResourceCostItemResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfResourceCostItemResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfResourceCostItemResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfResourceCostItemResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfResourceCostItemResponseModel struct {
	value *CollectionModelOfResourceCostItemResponseModel
	isSet bool
}

func (v NullableCollectionModelOfResourceCostItemResponseModel) Get() *CollectionModelOfResourceCostItemResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfResourceCostItemResponseModel) Set(val *CollectionModelOfResourceCostItemResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfResourceCostItemResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfResourceCostItemResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfResourceCostItemResponseModel(val *CollectionModelOfResourceCostItemResponseModel) *NullableCollectionModelOfResourceCostItemResponseModel {
	return &NullableCollectionModelOfResourceCostItemResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfResourceCostItemResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfResourceCostItemResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
