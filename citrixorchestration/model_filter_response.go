...
type FilterResponse struct {
	// GUID of the policy that owns this filter.
	...
	// The filtered policy is allowed or denied if the filter condition is met.
	IsAllowed *bool `json:"isAllowed,omitempty"`
	// Is filter enabled or disabled.
	IsEnabled *bool `json:"isEnabled,omitempty"`
	// The data for the filter as a JSON string. This is ignored if the filter is Citrix SD-Wan.
