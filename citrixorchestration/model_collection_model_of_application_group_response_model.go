...
// checks if the CollectionModelOfApplicationGroupResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfApplicationGroupResponseModel{}

// CollectionModelOfApplicationGroupResponseModel Response object for collections of items.
type CollectionModelOfApplicationGroupResponseModel struct {
	// List of items.
...
func NewCollectionModelOfApplicationGroupResponseModel(items []ApplicationGroupResponseModel) *CollectionModelOfApplicationGroupResponseModel {
	this := CollectionModelOfApplicationGroupResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfApplicationGroupResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfApplicationGroupResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfApplicationGroupResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfApplicationGroupResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfApplicationGroupResponseModel struct {
	value *CollectionModelOfApplicationGroupResponseModel
	isSet bool
}

func (v NullableCollectionModelOfApplicationGroupResponseModel) Get() *CollectionModelOfApplicationGroupResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfApplicationGroupResponseModel) Set(val *CollectionModelOfApplicationGroupResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfApplicationGroupResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfApplicationGroupResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfApplicationGroupResponseModel(val *CollectionModelOfApplicationGroupResponseModel) *NullableCollectionModelOfApplicationGroupResponseModel {
	return &NullableCollectionModelOfApplicationGroupResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfApplicationGroupResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfApplicationGroupResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
