...
// checks if the SessionResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionResponseModelCollection{}

// SessionResponseModelCollection struct for SessionResponseModelCollection
type SessionResponseModelCollection struct {
	// List of items.
...
type _SessionResponseModelCollection SessionResponseModelCollection
...
func NewSessionResponseModelCollection(items []SessionResponseModel) *SessionResponseModelCollection {
	this := SessionResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *SessionResponseModelCollection) SetContinuationTokenNil() {
...
func (o *SessionResponseModelCollection) SetTotalItemsNil() {
...
func (o SessionResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o SessionResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableSessionResponseModelCollection struct {
	value *SessionResponseModelCollection
	isSet bool
}

func (v NullableSessionResponseModelCollection) Get() *SessionResponseModelCollection {
	return v.value
}

func (v *NullableSessionResponseModelCollection) Set(val *SessionResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionResponseModelCollection(val *SessionResponseModelCollection) *NullableSessionResponseModelCollection {
	return &NullableSessionResponseModelCollection{value: val, isSet: true}
}

func (v NullableSessionResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
