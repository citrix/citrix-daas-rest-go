...
// checks if the HypervisorResourceValidationResponseModelResourceRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourceValidationResponseModelResourceRef{}

// HypervisorResourceValidationResponseModelResourceRef The resource reference. Only the attibute FullRelativePath is populated in response.
type HypervisorResourceValidationResponseModelResourceRef struct {
	// Id of the resource.
...
func NewHypervisorResourceValidationResponseModelResourceRef() *HypervisorResourceValidationResponseModelResourceRef {
	this := HypervisorResourceValidationResponseModelResourceRef{}
	return &this
}
...
func (o HypervisorResourceValidationResponseModelResourceRef) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourceValidationResponseModelResourceRef) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourceValidationResponseModelResourceRef struct {
	value *HypervisorResourceValidationResponseModelResourceRef
	isSet bool
}

func (v NullableHypervisorResourceValidationResponseModelResourceRef) Get() *HypervisorResourceValidationResponseModelResourceRef {
	return v.value
}

func (v *NullableHypervisorResourceValidationResponseModelResourceRef) Set(val *HypervisorResourceValidationResponseModelResourceRef) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourceValidationResponseModelResourceRef) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourceValidationResponseModelResourceRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourceValidationResponseModelResourceRef(val *HypervisorResourceValidationResponseModelResourceRef) *NullableHypervisorResourceValidationResponseModelResourceRef {
	return &NullableHypervisorResourceValidationResponseModelResourceRef{value: val, isSet: true}
}

func (v NullableHypervisorResourceValidationResponseModelResourceRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourceValidationResponseModelResourceRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
