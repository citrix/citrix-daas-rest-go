...
// checks if the PvsCollectionResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PvsCollectionResponseModelCollection{}

// PvsCollectionResponseModelCollection struct for PvsCollectionResponseModelCollection
type PvsCollectionResponseModelCollection struct {
	// List of items.
...
func NewPvsCollectionResponseModelCollection(items []PvsCollectionResponseModel) *PvsCollectionResponseModelCollection {
	this := PvsCollectionResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PvsCollectionResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PvsCollectionResponseModelCollection) SetTotalItemsNil() {
...
func (o PvsCollectionResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PvsCollectionResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePvsCollectionResponseModelCollection struct {
	value *PvsCollectionResponseModelCollection
	isSet bool
}

func (v NullablePvsCollectionResponseModelCollection) Get() *PvsCollectionResponseModelCollection {
	return v.value
}

func (v *NullablePvsCollectionResponseModelCollection) Set(val *PvsCollectionResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePvsCollectionResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePvsCollectionResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePvsCollectionResponseModelCollection(val *PvsCollectionResponseModelCollection) *NullablePvsCollectionResponseModelCollection {
	return &NullablePvsCollectionResponseModelCollection{value: val, isSet: true}
}

func (v NullablePvsCollectionResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePvsCollectionResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
