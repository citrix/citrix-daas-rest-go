...
// GetIconFormat returns the IconFormat field value if set, zero value otherwise.
func (o *AppvServerPackageApplicationIconRequestModel) GetIconFormat() string {
	if o == nil || IsNil(o.IconFormat) {
		var ret string
		return ret
	}
	return *o.IconFormat
...
// SetIconFormat gets a reference to the given string and assigns it to the IconFormat field.
...
func (o AppvServerPackageApplicationIconRequestModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IconFormat) {
		toSerialize["IconFormat"] = o.IconFormat
	}
