...
// checks if the HypervisorDetailTraditionalResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorDetailTraditionalResponseModel{}

// HypervisorDetailTraditionalResponseModel struct for HypervisorDetailTraditionalResponseModel
type HypervisorDetailTraditionalResponseModel struct {
	// Id of the resource.
...
func NewHypervisorDetailTraditionalResponseModel(connectionType HypervisorConnectionType, addresses []string, inMaintenanceMode bool, pluginId string, scopes []ScopeResponseModel, usesCloudInfrastructure bool, zone HypervisorResponseModelAllOfZone, capabilities []string, configurationObjectCapabilities []HypervisorConfigurationObjectCapability, pluginRevision string, maxAbsoluteActiveActions int32, maxAbsoluteNewActionsPerMinute int32, maxPowerActionsPercentageOfMachines int32, connectionOptions string, supportsLocalStorageCaching bool, supportsPvsVms bool, userName string) *HypervisorDetailTraditionalResponseModel {
	this := HypervisorDetailTraditionalResponseModel{}
...
func (o HypervisorDetailTraditionalResponseModel) MarshalJSON() ([]byte, error) {
...
func (o HypervisorDetailTraditionalResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorDetailTraditionalResponseModel struct {
	value *HypervisorDetailTraditionalResponseModel
	isSet bool
}

func (v NullableHypervisorDetailTraditionalResponseModel) Get() *HypervisorDetailTraditionalResponseModel {
	return v.value
}

func (v *NullableHypervisorDetailTraditionalResponseModel) Set(val *HypervisorDetailTraditionalResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorDetailTraditionalResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorDetailTraditionalResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorDetailTraditionalResponseModel(val *HypervisorDetailTraditionalResponseModel) *NullableHypervisorDetailTraditionalResponseModel {
	return &NullableHypervisorDetailTraditionalResponseModel{value: val, isSet: true}
}

func (v NullableHypervisorDetailTraditionalResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorDetailTraditionalResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
