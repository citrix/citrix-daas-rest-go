...
// checks if the CollectionModelOfJobResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfJobResponseModel{}

// CollectionModelOfJobResponseModel Response object for collections of items.
type CollectionModelOfJobResponseModel struct {
	// List of items.
...
type _CollectionModelOfJobResponseModel CollectionModelOfJobResponseModel
...
func NewCollectionModelOfJobResponseModel(items []JobResponseModel) *CollectionModelOfJobResponseModel {
	this := CollectionModelOfJobResponseModel{}
	this.Items = items
	return &this
}
...
func (o CollectionModelOfJobResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfJobResponseModel struct {
	value *CollectionModelOfJobResponseModel
	isSet bool
}

func (v NullableCollectionModelOfJobResponseModel) Get() *CollectionModelOfJobResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfJobResponseModel) Set(val *CollectionModelOfJobResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfJobResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfJobResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfJobResponseModel(val *CollectionModelOfJobResponseModel) *NullableCollectionModelOfJobResponseModel {
	return &NullableCollectionModelOfJobResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfJobResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfJobResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
