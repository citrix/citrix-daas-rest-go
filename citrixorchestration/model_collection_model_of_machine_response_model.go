...
// checks if the CollectionModelOfMachineResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfMachineResponseModel{}

// CollectionModelOfMachineResponseModel Response object for collections of items.
type CollectionModelOfMachineResponseModel struct {
	// List of items.
...
type _CollectionModelOfMachineResponseModel CollectionModelOfMachineResponseModel
...
func NewCollectionModelOfMachineResponseModel(items []MachineResponseModel) *CollectionModelOfMachineResponseModel {
	this := CollectionModelOfMachineResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfMachineResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfMachineResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfMachineResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfMachineResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfMachineResponseModel struct {
	value *CollectionModelOfMachineResponseModel
	isSet bool
}

func (v NullableCollectionModelOfMachineResponseModel) Get() *CollectionModelOfMachineResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfMachineResponseModel) Set(val *CollectionModelOfMachineResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfMachineResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfMachineResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfMachineResponseModel(val *CollectionModelOfMachineResponseModel) *NullableCollectionModelOfMachineResponseModel {
	return &NullableCollectionModelOfMachineResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfMachineResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfMachineResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
