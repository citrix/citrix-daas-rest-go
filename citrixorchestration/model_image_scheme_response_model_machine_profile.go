...
// checks if the ImageSchemeResponseModelMachineProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageSchemeResponseModelMachineProfile{}

// ImageSchemeResponseModelMachineProfile The machine profile that the scheme uses.
type ImageSchemeResponseModelMachineProfile struct {
	// Id of the resource.
...
func NewImageSchemeResponseModelMachineProfile() *ImageSchemeResponseModelMachineProfile {
	this := ImageSchemeResponseModelMachineProfile{}
	return &this
}
...
func (o ImageSchemeResponseModelMachineProfile) MarshalJSON() ([]byte, error) {
...
func (o ImageSchemeResponseModelMachineProfile) ToMap() (map[string]interface{}, error) {
...
type NullableImageSchemeResponseModelMachineProfile struct {
	value *ImageSchemeResponseModelMachineProfile
	isSet bool
}

func (v NullableImageSchemeResponseModelMachineProfile) Get() *ImageSchemeResponseModelMachineProfile {
	return v.value
}

func (v *NullableImageSchemeResponseModelMachineProfile) Set(val *ImageSchemeResponseModelMachineProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableImageSchemeResponseModelMachineProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableImageSchemeResponseModelMachineProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageSchemeResponseModelMachineProfile(val *ImageSchemeResponseModelMachineProfile) *NullableImageSchemeResponseModelMachineProfile {
	return &NullableImageSchemeResponseModelMachineProfile{value: val, isSet: true}
}

func (v NullableImageSchemeResponseModelMachineProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageSchemeResponseModelMachineProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
