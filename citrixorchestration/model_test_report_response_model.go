...
type TestReportResponseModel struct {
	...
	FormattedReportTime *string `json:"FormattedReportTime,omitempty"`
	// The test results
...
// GetFormattedReportTime returns the FormattedReportTime field value if set, zero value otherwise.
func (o *TestReportResponseModel) GetFormattedReportTime() string {
	if o == nil || IsNil(o.FormattedReportTime) {
		var ret string
		return ret
	}
	return *o.FormattedReportTime
}
...
func (o *TestReportResponseModel) GetFormattedReportTimeOk() (*string, bool) {
	...
	return o.FormattedReportTime, true
}
...
// SetFormattedReportTime gets a reference to the given string and assigns it to the FormattedReportTime field.
func (o *TestReportResponseModel) SetFormattedReportTime(v string) {
	o.FormattedReportTime = &v
}
...
func (o TestReportResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FormattedReportTime) {
		toSerialize["FormattedReportTime"] = o.FormattedReportTime
	}
