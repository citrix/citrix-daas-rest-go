...
// checks if the CollectionModelOfBackupRestoreHistoryInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfBackupRestoreHistoryInformation{}

// CollectionModelOfBackupRestoreHistoryInformation Response object for collections of items.
type CollectionModelOfBackupRestoreHistoryInformation struct {
	// List of items.
	Items []BackupRestoreHistoryInformation `json:"Items"`
...
type _CollectionModelOfBackupRestoreHistoryInformation CollectionModelOfBackupRestoreHistoryInformation
...
func NewCollectionModelOfBackupRestoreHistoryInformation(items []BackupRestoreHistoryInformation) *CollectionModelOfBackupRestoreHistoryInformation {
	this := CollectionModelOfBackupRestoreHistoryInformation{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfBackupRestoreHistoryInformation) GetItems() []BackupRestoreHistoryInformation {
	if o == nil {
		var ret []BackupRestoreHistoryInformation
		return ret
	}
...
func (o *CollectionModelOfBackupRestoreHistoryInformation) SetContinuationTokenNil() {
...
func (o *CollectionModelOfBackupRestoreHistoryInformation) SetTotalItemsNil() {
...
func (o CollectionModelOfBackupRestoreHistoryInformation) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfBackupRestoreHistoryInformation) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfBackupRestoreHistoryInformation struct {
	value *CollectionModelOfBackupRestoreHistoryInformation
	isSet bool
}

func (v NullableCollectionModelOfBackupRestoreHistoryInformation) Get() *CollectionModelOfBackupRestoreHistoryInformation {
	return v.value
}

func (v *NullableCollectionModelOfBackupRestoreHistoryInformation) Set(val *CollectionModelOfBackupRestoreHistoryInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfBackupRestoreHistoryInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfBackupRestoreHistoryInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfBackupRestoreHistoryInformation(val *CollectionModelOfBackupRestoreHistoryInformation) *NullableCollectionModelOfBackupRestoreHistoryInformation {
	return &NullableCollectionModelOfBackupRestoreHistoryInformation{value: val, isSet: true}
}

func (v NullableCollectionModelOfBackupRestoreHistoryInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfBackupRestoreHistoryInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
