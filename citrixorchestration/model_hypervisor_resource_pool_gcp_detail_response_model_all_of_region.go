...
// checks if the HypervisorResourcePoolGcpDetailResponseModelAllOfRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolGcpDetailResponseModelAllOfRegion{}

// HypervisorResourcePoolGcpDetailResponseModelAllOfRegion Google Cloud Platform region which the resource pool is connected to.
type HypervisorResourcePoolGcpDetailResponseModelAllOfRegion struct {
	// Id of the resource.
...
func NewHypervisorResourcePoolGcpDetailResponseModelAllOfRegion() *HypervisorResourcePoolGcpDetailResponseModelAllOfRegion {
	this := HypervisorResourcePoolGcpDetailResponseModelAllOfRegion{}
	return &this
}
...
func (o HypervisorResourcePoolGcpDetailResponseModelAllOfRegion) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolGcpDetailResponseModelAllOfRegion) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion struct {
	value *HypervisorResourcePoolGcpDetailResponseModelAllOfRegion
	isSet bool
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) Get() *HypervisorResourcePoolGcpDetailResponseModelAllOfRegion {
	return v.value
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) Set(val *HypervisorResourcePoolGcpDetailResponseModelAllOfRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion(val *HypervisorResourcePoolGcpDetailResponseModelAllOfRegion) *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion {
	return &NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
