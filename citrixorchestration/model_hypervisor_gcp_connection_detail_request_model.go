...
// checks if the HypervisorGCPConnectionDetailRequestModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorGCPConnectionDetailRequestModel{}

// HypervisorGCPConnectionDetailRequestModel struct for HypervisorGCPConnectionDetailRequestModel
type HypervisorGCPConnectionDetailRequestModel struct {
...
func NewHypervisorGCPConnectionDetailRequestModel(name string, connectionType HypervisorConnectionType, serviceAccountId string, serviceAccountCredentials string) *HypervisorGCPConnectionDetailRequestModel {
	this := HypervisorGCPConnectionDetailRequestModel{}
	this.Name = name
...
func (o HypervisorGCPConnectionDetailRequestModel) MarshalJSON() ([]byte, error) {
...
func (o HypervisorGCPConnectionDetailRequestModel) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorGCPConnectionDetailRequestModel struct {
	value *HypervisorGCPConnectionDetailRequestModel
	isSet bool
}

func (v NullableHypervisorGCPConnectionDetailRequestModel) Get() *HypervisorGCPConnectionDetailRequestModel {
	return v.value
}

func (v *NullableHypervisorGCPConnectionDetailRequestModel) Set(val *HypervisorGCPConnectionDetailRequestModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorGCPConnectionDetailRequestModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorGCPConnectionDetailRequestModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorGCPConnectionDetailRequestModel(val *HypervisorGCPConnectionDetailRequestModel) *NullableHypervisorGCPConnectionDetailRequestModel {
	return &NullableHypervisorGCPConnectionDetailRequestModel{value: val, isSet: true}
}

func (v NullableHypervisorGCPConnectionDetailRequestModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorGCPConnectionDetailRequestModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
