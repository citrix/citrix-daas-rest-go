...
// checks if the JobResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobResponseModelCollection{}

// JobResponseModelCollection struct for JobResponseModelCollection
type JobResponseModelCollection struct {
	// List of items.
	Items []JobResponseModel `json:"Items"`
...
type _JobResponseModelCollection JobResponseModelCollection
...
func NewJobResponseModelCollection(items []JobResponseModel) *JobResponseModelCollection {
	this := JobResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *JobResponseModelCollection) SetContinuationTokenNil() {
...
func (o *JobResponseModelCollection) SetTotalItemsNil() {
...
func (o JobResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o JobResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableJobResponseModelCollection struct {
	value *JobResponseModelCollection
	isSet bool
}

func (v NullableJobResponseModelCollection) Get() *JobResponseModelCollection {
	return v.value
}

func (v *NullableJobResponseModelCollection) Set(val *JobResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableJobResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableJobResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobResponseModelCollection(val *JobResponseModelCollection) *NullableJobResponseModelCollection {
	return &NullableJobResponseModelCollection{value: val, isSet: true}
}

func (v NullableJobResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
