...
// checks if the PowerTimeSchemeResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PowerTimeSchemeResponseModelCollection{}

// PowerTimeSchemeResponseModelCollection struct for PowerTimeSchemeResponseModelCollection
type PowerTimeSchemeResponseModelCollection struct {
	// List of items.
...
type _PowerTimeSchemeResponseModelCollection PowerTimeSchemeResponseModelCollection
...
func NewPowerTimeSchemeResponseModelCollection(items []PowerTimeSchemeResponseModel) *PowerTimeSchemeResponseModelCollection {
	this := PowerTimeSchemeResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PowerTimeSchemeResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PowerTimeSchemeResponseModelCollection) SetTotalItemsNil() {
...
func (o PowerTimeSchemeResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PowerTimeSchemeResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePowerTimeSchemeResponseModelCollection struct {
	value *PowerTimeSchemeResponseModelCollection
	isSet bool
}

func (v NullablePowerTimeSchemeResponseModelCollection) Get() *PowerTimeSchemeResponseModelCollection {
	return v.value
}

func (v *NullablePowerTimeSchemeResponseModelCollection) Set(val *PowerTimeSchemeResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePowerTimeSchemeResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePowerTimeSchemeResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePowerTimeSchemeResponseModelCollection(val *PowerTimeSchemeResponseModelCollection) *NullablePowerTimeSchemeResponseModelCollection {
	return &NullablePowerTimeSchemeResponseModelCollection{value: val, isSet: true}
}

func (v NullablePowerTimeSchemeResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePowerTimeSchemeResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
