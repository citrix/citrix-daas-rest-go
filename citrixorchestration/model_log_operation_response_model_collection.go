...
// checks if the LogOperationResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogOperationResponseModelCollection{}

// LogOperationResponseModelCollection struct for LogOperationResponseModelCollection
type LogOperationResponseModelCollection struct {
	// List of items.
...
type _LogOperationResponseModelCollection LogOperationResponseModelCollection
...
func NewLogOperationResponseModelCollection(items []LogOperationResponseModel) *LogOperationResponseModelCollection {
	this := LogOperationResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *LogOperationResponseModelCollection) SetContinuationTokenNil() {
...
func (o *LogOperationResponseModelCollection) SetTotalItemsNil() {
...
func (o LogOperationResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o LogOperationResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableLogOperationResponseModelCollection struct {
	value *LogOperationResponseModelCollection
	isSet bool
}

func (v NullableLogOperationResponseModelCollection) Get() *LogOperationResponseModelCollection {
	return v.value
}

func (v *NullableLogOperationResponseModelCollection) Set(val *LogOperationResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableLogOperationResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableLogOperationResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogOperationResponseModelCollection(val *LogOperationResponseModelCollection) *NullableLogOperationResponseModelCollection {
	return &NullableLogOperationResponseModelCollection{value: val, isSet: true}
}

func (v NullableLogOperationResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogOperationResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
