...
func NewHypervisorMachineCatalogResponseModel(name string, id string, allocationType AllocationType, availableCount int32, isRemotePC bool, machineType MachineType, minimumFunctionalLevel FunctionalLevel, hasBeenPromoted bool, canRollbackVMImage bool, canRecreateCatalog bool, persistChanges PersistChanges, provisioningType ProvisioningType, sessionSupport SessionSupport, sharingKind SharingKind, totalCount int32, isBroken bool, unassignedCount int32, usedCount int32, zone MachineCatalogResponseModelZone) *HypervisorMachineCatalogResponseModel {
	this := HypervisorMachineCatalogResponseModel{}
	this.Name = name
	this.Id = id
...
func (o HypervisorMachineCatalogResponseModel) MarshalJSON() ([]byte, error) {
...
func (o HypervisorMachineCatalogResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorMachineCatalogResponseModel struct {
	value *HypervisorMachineCatalogResponseModel
	isSet bool
}

func (v NullableHypervisorMachineCatalogResponseModel) Get() *HypervisorMachineCatalogResponseModel {
	return v.value
}

func (v *NullableHypervisorMachineCatalogResponseModel) Set(val *HypervisorMachineCatalogResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorMachineCatalogResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorMachineCatalogResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorMachineCatalogResponseModel(val *HypervisorMachineCatalogResponseModel) *NullableHypervisorMachineCatalogResponseModel {
	return &NullableHypervisorMachineCatalogResponseModel{value: val, isSet: true}
}

func (v NullableHypervisorMachineCatalogResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorMachineCatalogResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
