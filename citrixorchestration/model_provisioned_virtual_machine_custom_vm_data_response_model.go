...
type ProvisionedVirtualMachineCustomVmDataResponseModel struct {
	...
	PersistWbc NullableBool `json:"PersistWbc,omitempty"`
	// Region Id
...
// GetPersistWbc returns the PersistWbc field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProvisionedVirtualMachineCustomVmDataResponseModel) GetPersistWbc() bool {
	if o == nil || IsNil(o.PersistWbc.Get()) {
		var ret bool
		return ret
	}
	return *o.PersistWbc.Get()
}
...
func (o *ProvisionedVirtualMachineCustomVmDataResponseModel) GetPersistWbcOk() (*bool, bool) {
	...
	return o.PersistWbc.Get(), o.PersistWbc.IsSet()
}
...
// SetPersistWbc gets a reference to the given NullableBool and assigns it to the PersistWbc field.
...
func (o *ProvisionedVirtualMachineCustomVmDataResponseModel) SetPersistWbcNil() {
	o.PersistWbc.Set(nil)
}
...
func (o ProvisionedVirtualMachineCustomVmDataResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if o.PersistWbc.IsSet() {
		toSerialize["PersistWbc"] = o.PersistWbc.Get()
	}
	if o.RegionId.IsSet() {
