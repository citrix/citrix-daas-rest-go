...
// checks if the StartMenuApplicationResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StartMenuApplicationResponseModelCollection{}

// StartMenuApplicationResponseModelCollection struct for StartMenuApplicationResponseModelCollection
type StartMenuApplicationResponseModelCollection struct {
	// List of items.
	Items []StartMenuApplicationResponseModel `json:"Items"`
...
type _StartMenuApplicationResponseModelCollection StartMenuApplicationResponseModelCollection
...
func NewStartMenuApplicationResponseModelCollection(items []StartMenuApplicationResponseModel) *StartMenuApplicationResponseModelCollection {
	this := StartMenuApplicationResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *StartMenuApplicationResponseModelCollection) GetItems() []StartMenuApplicationResponseModel {
	if o == nil {
		var ret []StartMenuApplicationResponseModel
		return ret
	}
...
func (o *StartMenuApplicationResponseModelCollection) SetContinuationTokenNil() {
...
func (o *StartMenuApplicationResponseModelCollection) SetTotalItemsNil() {
...
func (o StartMenuApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o StartMenuApplicationResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableStartMenuApplicationResponseModelCollection struct {
	value *StartMenuApplicationResponseModelCollection
	isSet bool
}

func (v NullableStartMenuApplicationResponseModelCollection) Get() *StartMenuApplicationResponseModelCollection {
	return v.value
}

func (v *NullableStartMenuApplicationResponseModelCollection) Set(val *StartMenuApplicationResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableStartMenuApplicationResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableStartMenuApplicationResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStartMenuApplicationResponseModelCollection(val *StartMenuApplicationResponseModelCollection) *NullableStartMenuApplicationResponseModelCollection {
	return &NullableStartMenuApplicationResponseModelCollection{value: val, isSet: true}
}

func (v NullableStartMenuApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStartMenuApplicationResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
