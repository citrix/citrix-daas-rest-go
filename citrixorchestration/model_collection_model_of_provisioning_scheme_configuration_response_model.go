...
// checks if the CollectionModelOfProvisioningSchemeConfigurationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisioningSchemeConfigurationResponseModel{}

// CollectionModelOfProvisioningSchemeConfigurationResponseModel Response object for collections of items.
type CollectionModelOfProvisioningSchemeConfigurationResponseModel struct {
	// List of items.
...
type _CollectionModelOfProvisioningSchemeConfigurationResponseModel CollectionModelOfProvisioningSchemeConfigurationResponseModel
...
func NewCollectionModelOfProvisioningSchemeConfigurationResponseModel(items []ProvisioningSchemeConfigurationResponseModel) *CollectionModelOfProvisioningSchemeConfigurationResponseModel {
	this := CollectionModelOfProvisioningSchemeConfigurationResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisioningSchemeConfigurationResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisioningSchemeConfigurationResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisioningSchemeConfigurationResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisioningSchemeConfigurationResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel struct {
	value *CollectionModelOfProvisioningSchemeConfigurationResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) Get() *CollectionModelOfProvisioningSchemeConfigurationResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) Set(val *CollectionModelOfProvisioningSchemeConfigurationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisioningSchemeConfigurationResponseModel(val *CollectionModelOfProvisioningSchemeConfigurationResponseModel) *NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel {
	return &NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisioningSchemeConfigurationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
