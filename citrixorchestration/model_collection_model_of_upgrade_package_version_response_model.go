...
// checks if the CollectionModelOfUpgradePackageVersionResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfUpgradePackageVersionResponseModel{}

// CollectionModelOfUpgradePackageVersionResponseModel Response object for collections of items.
type CollectionModelOfUpgradePackageVersionResponseModel struct {
	// List of items.
...
type _CollectionModelOfUpgradePackageVersionResponseModel CollectionModelOfUpgradePackageVersionResponseModel
...
func NewCollectionModelOfUpgradePackageVersionResponseModel(items []UpgradePackageVersionResponseModel) *CollectionModelOfUpgradePackageVersionResponseModel {
	this := CollectionModelOfUpgradePackageVersionResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfUpgradePackageVersionResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfUpgradePackageVersionResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfUpgradePackageVersionResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfUpgradePackageVersionResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfUpgradePackageVersionResponseModel struct {
	value *CollectionModelOfUpgradePackageVersionResponseModel
	isSet bool
}

func (v NullableCollectionModelOfUpgradePackageVersionResponseModel) Get() *CollectionModelOfUpgradePackageVersionResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfUpgradePackageVersionResponseModel) Set(val *CollectionModelOfUpgradePackageVersionResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfUpgradePackageVersionResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfUpgradePackageVersionResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfUpgradePackageVersionResponseModel(val *CollectionModelOfUpgradePackageVersionResponseModel) *NullableCollectionModelOfUpgradePackageVersionResponseModel {
	return &NullableCollectionModelOfUpgradePackageVersionResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfUpgradePackageVersionResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfUpgradePackageVersionResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
