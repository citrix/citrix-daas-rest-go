...
// Citrix Customer ID. Default is &#39;CitrixOnPremises&#39;
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) CitrixCustomerId(citrixCustomerId string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.citrixCustomerId = &citrixCustomerId
	return r
}

// Citrix Instance (Site) ID.
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) CitrixInstanceId(citrixInstanceId string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.citrixInstanceId = &citrixInstanceId
	return r
}

func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) DeliveryGroupsFtaRequestModel(deliveryGroupsFtaRequestModel DeliveryGroupsFtaRequestModel) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.deliveryGroupsFtaRequestModel = &deliveryGroupsFtaRequestModel
	return r
}

// User Agent type of the request.
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) UserAgent(userAgent string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.userAgent = &userAgent
	return r
}

// Citrix authorization header: CWSAuth Bearer&#x3D;{token}
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) Authorization(authorization string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.authorization = &authorization
	return r
}

// Transaction ID that will be used to track this request. If not provided, a new GUID will be generated and returned.
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) CitrixTransactionId(citrixTransactionId string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.citrixTransactionId = &citrixTransactionId
	return r
}

// Must accept application/json.
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) Accept(accept string) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.accept = &accept
	return r
}
...
func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) Async(async bool) ApiDeliveryGroupsGetDeliveryGroupFtasRequest {
	r.async = &async
	return r
}

func (r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) Execute() (*FtaResponseModelCollection, *http.Response, error) {
	return r.ApiService.DeliveryGroupsGetDeliveryGroupFtasExecute(r)
}
...
func (a *DeliveryGroupsAPIsDAASService) DeliveryGroupsGetDeliveryGroupFtasExecute(r ApiDeliveryGroupsGetDeliveryGroupFtasRequest) (*FtaResponseModelCollection, *http.Response, error) {
	...
	localVarPath := localBasePath + "/DeliveryGroups/$GetFileTypes"
	...
	if r.deliveryGroupsFtaRequestModel == nil {
	...
	if r.executableName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "executableName", r.executableName, "form", "")
	}
	if r.async != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "async", r.async, "form", "")
	} else {
	...
	// body params
	localVarPostBody = r.deliveryGroupsFtaRequestModel
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["BearerAuth"]; ok {
...
func (a *DeliveryGroupsAPIsDAASService) DeliveryGroupsGetDeliveryGroupStartMenuApplicationsExecute(r ApiDeliveryGroupsGetDeliveryGroupStartMenuApplicationsRequest) (*StartMenuApplicationResponseModelCollection, *http.Response, error) {
	...
	if r.tagRestriction != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tagRestriction", r.tagRestriction, "form", "")
	}
	if r.async != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "async", r.async, "form", "")
	} else {
