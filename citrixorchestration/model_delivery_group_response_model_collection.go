...
// checks if the DeliveryGroupResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliveryGroupResponseModelCollection{}

// DeliveryGroupResponseModelCollection struct for DeliveryGroupResponseModelCollection
type DeliveryGroupResponseModelCollection struct {
	// List of items.
...
type _DeliveryGroupResponseModelCollection DeliveryGroupResponseModelCollection
...
func NewDeliveryGroupResponseModelCollection(items []DeliveryGroupResponseModel) *DeliveryGroupResponseModelCollection {
	this := DeliveryGroupResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *DeliveryGroupResponseModelCollection) SetContinuationTokenNil() {
...
func (o *DeliveryGroupResponseModelCollection) SetTotalItemsNil() {
...
func (o DeliveryGroupResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o DeliveryGroupResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableDeliveryGroupResponseModelCollection struct {
	value *DeliveryGroupResponseModelCollection
	isSet bool
}

func (v NullableDeliveryGroupResponseModelCollection) Get() *DeliveryGroupResponseModelCollection {
	return v.value
}

func (v *NullableDeliveryGroupResponseModelCollection) Set(val *DeliveryGroupResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliveryGroupResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableDeliveryGroupResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeliveryGroupResponseModelCollection(val *DeliveryGroupResponseModelCollection) *NullableDeliveryGroupResponseModelCollection {
	return &NullableDeliveryGroupResponseModelCollection{value: val, isSet: true}
}

func (v NullableDeliveryGroupResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeliveryGroupResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
