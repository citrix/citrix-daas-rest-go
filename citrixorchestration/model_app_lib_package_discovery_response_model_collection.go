...
// checks if the AppLibPackageDiscoveryResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppLibPackageDiscoveryResponseModelCollection{}

// AppLibPackageDiscoveryResponseModelCollection struct for AppLibPackageDiscoveryResponseModelCollection
type AppLibPackageDiscoveryResponseModelCollection struct {
	// List of items.
...
type _AppLibPackageDiscoveryResponseModelCollection AppLibPackageDiscoveryResponseModelCollection
...
func NewAppLibPackageDiscoveryResponseModelCollection(items []AppLibPackageDiscoveryResponseModel) *AppLibPackageDiscoveryResponseModelCollection {
	this := AppLibPackageDiscoveryResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AppLibPackageDiscoveryResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AppLibPackageDiscoveryResponseModelCollection) SetTotalItemsNil() {
...
func (o AppLibPackageDiscoveryResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AppLibPackageDiscoveryResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppLibPackageDiscoveryResponseModelCollection struct {
	value *AppLibPackageDiscoveryResponseModelCollection
	isSet bool
}

func (v NullableAppLibPackageDiscoveryResponseModelCollection) Get() *AppLibPackageDiscoveryResponseModelCollection {
	return v.value
}

func (v *NullableAppLibPackageDiscoveryResponseModelCollection) Set(val *AppLibPackageDiscoveryResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppLibPackageDiscoveryResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppLibPackageDiscoveryResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppLibPackageDiscoveryResponseModelCollection(val *AppLibPackageDiscoveryResponseModelCollection) *NullableAppLibPackageDiscoveryResponseModelCollection {
	return &NullableAppLibPackageDiscoveryResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppLibPackageDiscoveryResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppLibPackageDiscoveryResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
