...
// checks if the HypervisorResourcePoolAzureDetailResponseModelAllOfRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolAzureDetailResponseModelAllOfRegion{}

// HypervisorResourcePoolAzureDetailResponseModelAllOfRegion Azure region which the resource pool is connected to.
type HypervisorResourcePoolAzureDetailResponseModelAllOfRegion struct {
	// Id of the resource.
...
func NewHypervisorResourcePoolAzureDetailResponseModelAllOfRegion() *HypervisorResourcePoolAzureDetailResponseModelAllOfRegion {
	this := HypervisorResourcePoolAzureDetailResponseModelAllOfRegion{}
	return &this
}
...
func (o HypervisorResourcePoolAzureDetailResponseModelAllOfRegion) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolAzureDetailResponseModelAllOfRegion) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion struct {
	value *HypervisorResourcePoolAzureDetailResponseModelAllOfRegion
	isSet bool
}

func (v NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) Get() *HypervisorResourcePoolAzureDetailResponseModelAllOfRegion {
	return v.value
}

func (v *NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) Set(val *HypervisorResourcePoolAzureDetailResponseModelAllOfRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion(val *HypervisorResourcePoolAzureDetailResponseModelAllOfRegion) *NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion {
	return &NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolAzureDetailResponseModelAllOfRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
