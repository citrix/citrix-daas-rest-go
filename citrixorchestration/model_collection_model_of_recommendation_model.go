...
// checks if the CollectionModelOfRecommendationModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfRecommendationModel{}

// CollectionModelOfRecommendationModel Response object for collections of items.
type CollectionModelOfRecommendationModel struct {
	// List of items.
...
type _CollectionModelOfRecommendationModel CollectionModelOfRecommendationModel
...
func NewCollectionModelOfRecommendationModel(items []RecommendationModel) *CollectionModelOfRecommendationModel {
	this := CollectionModelOfRecommendationModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfRecommendationModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfRecommendationModel) SetTotalItemsNil() {
...
func (o CollectionModelOfRecommendationModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfRecommendationModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfRecommendationModel struct {
	value *CollectionModelOfRecommendationModel
	isSet bool
}

func (v NullableCollectionModelOfRecommendationModel) Get() *CollectionModelOfRecommendationModel {
	return v.value
}

func (v *NullableCollectionModelOfRecommendationModel) Set(val *CollectionModelOfRecommendationModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfRecommendationModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfRecommendationModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfRecommendationModel(val *CollectionModelOfRecommendationModel) *NullableCollectionModelOfRecommendationModel {
	return &NullableCollectionModelOfRecommendationModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfRecommendationModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfRecommendationModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
