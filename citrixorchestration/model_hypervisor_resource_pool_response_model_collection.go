...
// checks if the HypervisorResourcePoolResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolResponseModelCollection{}

// HypervisorResourcePoolResponseModelCollection struct for HypervisorResourcePoolResponseModelCollection
type HypervisorResourcePoolResponseModelCollection struct {
	// List of items.
...
type _HypervisorResourcePoolResponseModelCollection HypervisorResourcePoolResponseModelCollection
...
func NewHypervisorResourcePoolResponseModelCollection(items []HypervisorResourcePoolDetailResponseModel) *HypervisorResourcePoolResponseModelCollection {
	this := HypervisorResourcePoolResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *HypervisorResourcePoolResponseModelCollection) SetContinuationTokenNil() {
...
func (o *HypervisorResourcePoolResponseModelCollection) SetTotalItemsNil() {
...
func (o HypervisorResourcePoolResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolResponseModelCollection struct {
	value *HypervisorResourcePoolResponseModelCollection
	isSet bool
}

func (v NullableHypervisorResourcePoolResponseModelCollection) Get() *HypervisorResourcePoolResponseModelCollection {
	return v.value
}

func (v *NullableHypervisorResourcePoolResponseModelCollection) Set(val *HypervisorResourcePoolResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolResponseModelCollection(val *HypervisorResourcePoolResponseModelCollection) *NullableHypervisorResourcePoolResponseModelCollection {
	return &NullableHypervisorResourcePoolResponseModelCollection{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
