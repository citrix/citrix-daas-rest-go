...
// checks if the CollectionModelOfHypervisorResourcePoolNetworkResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfHypervisorResourcePoolNetworkResponseModel{}

// CollectionModelOfHypervisorResourcePoolNetworkResponseModel Response object for collections of items.
type CollectionModelOfHypervisorResourcePoolNetworkResponseModel struct {
	// List of items.
	Items []HypervisorResourcePoolNetworkResponseModel `json:"Items"`
...
type _CollectionModelOfHypervisorResourcePoolNetworkResponseModel CollectionModelOfHypervisorResourcePoolNetworkResponseModel
...
func NewCollectionModelOfHypervisorResourcePoolNetworkResponseModel(items []HypervisorResourcePoolNetworkResponseModel) *CollectionModelOfHypervisorResourcePoolNetworkResponseModel {
	this := CollectionModelOfHypervisorResourcePoolNetworkResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfHypervisorResourcePoolNetworkResponseModel) GetItems() []HypervisorResourcePoolNetworkResponseModel {
	if o == nil {
		var ret []HypervisorResourcePoolNetworkResponseModel
		return ret
	}
...
func (o *CollectionModelOfHypervisorResourcePoolNetworkResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfHypervisorResourcePoolNetworkResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfHypervisorResourcePoolNetworkResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfHypervisorResourcePoolNetworkResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel struct {
	value *CollectionModelOfHypervisorResourcePoolNetworkResponseModel
	isSet bool
}

func (v NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) Get() *CollectionModelOfHypervisorResourcePoolNetworkResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) Set(val *CollectionModelOfHypervisorResourcePoolNetworkResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel(val *CollectionModelOfHypervisorResourcePoolNetworkResponseModel) *NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel {
	return &NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfHypervisorResourcePoolNetworkResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
