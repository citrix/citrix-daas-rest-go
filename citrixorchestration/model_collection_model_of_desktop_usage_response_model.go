...
// checks if the CollectionModelOfDesktopUsageResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfDesktopUsageResponseModel{}

// CollectionModelOfDesktopUsageResponseModel Response object for collections of items.
type CollectionModelOfDesktopUsageResponseModel struct {
	// List of items.
	Items []DesktopUsageResponseModel `json:"Items"`
...
type _CollectionModelOfDesktopUsageResponseModel CollectionModelOfDesktopUsageResponseModel
...
func NewCollectionModelOfDesktopUsageResponseModel(items []DesktopUsageResponseModel) *CollectionModelOfDesktopUsageResponseModel {
	this := CollectionModelOfDesktopUsageResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfDesktopUsageResponseModel) GetItems() []DesktopUsageResponseModel {
	if o == nil {
		var ret []DesktopUsageResponseModel
		return ret
	}
...
func (o *CollectionModelOfDesktopUsageResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfDesktopUsageResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfDesktopUsageResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfDesktopUsageResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfDesktopUsageResponseModel struct {
	value *CollectionModelOfDesktopUsageResponseModel
	isSet bool
}

func (v NullableCollectionModelOfDesktopUsageResponseModel) Get() *CollectionModelOfDesktopUsageResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfDesktopUsageResponseModel) Set(val *CollectionModelOfDesktopUsageResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfDesktopUsageResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfDesktopUsageResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfDesktopUsageResponseModel(val *CollectionModelOfDesktopUsageResponseModel) *NullableCollectionModelOfDesktopUsageResponseModel {
	return &NullableCollectionModelOfDesktopUsageResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfDesktopUsageResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfDesktopUsageResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
