...
// checks if the HypervisorResourceResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourceResponseModelCollection{}

// HypervisorResourceResponseModelCollection struct for HypervisorResourceResponseModelCollection
type HypervisorResourceResponseModelCollection struct {
	// List of items.
...
type _HypervisorResourceResponseModelCollection HypervisorResourceResponseModelCollection
...
func NewHypervisorResourceResponseModelCollection(items []HypervisorResourceResponseModel) *HypervisorResourceResponseModelCollection {
	this := HypervisorResourceResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *HypervisorResourceResponseModelCollection) SetContinuationTokenNil() {
...
func (o *HypervisorResourceResponseModelCollection) SetTotalItemsNil() {
...
func (o HypervisorResourceResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourceResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourceResponseModelCollection struct {
	value *HypervisorResourceResponseModelCollection
	isSet bool
}

func (v NullableHypervisorResourceResponseModelCollection) Get() *HypervisorResourceResponseModelCollection {
	return v.value
}

func (v *NullableHypervisorResourceResponseModelCollection) Set(val *HypervisorResourceResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourceResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourceResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourceResponseModelCollection(val *HypervisorResourceResponseModelCollection) *NullableHypervisorResourceResponseModelCollection {
	return &NullableHypervisorResourceResponseModelCollection{value: val, isSet: true}
}

func (v NullableHypervisorResourceResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourceResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
