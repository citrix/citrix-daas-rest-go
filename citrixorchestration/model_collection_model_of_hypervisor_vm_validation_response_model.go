...
// checks if the CollectionModelOfHypervisorVmValidationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfHypervisorVmValidationResponseModel{}

// CollectionModelOfHypervisorVmValidationResponseModel Response object for collections of items.
type CollectionModelOfHypervisorVmValidationResponseModel struct {
	// List of items.
...
type _CollectionModelOfHypervisorVmValidationResponseModel CollectionModelOfHypervisorVmValidationResponseModel
...
func NewCollectionModelOfHypervisorVmValidationResponseModel(items []HypervisorVmValidationResponseModel) *CollectionModelOfHypervisorVmValidationResponseModel {
	this := CollectionModelOfHypervisorVmValidationResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfHypervisorVmValidationResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfHypervisorVmValidationResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfHypervisorVmValidationResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfHypervisorVmValidationResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfHypervisorVmValidationResponseModel struct {
	value *CollectionModelOfHypervisorVmValidationResponseModel
	isSet bool
}

func (v NullableCollectionModelOfHypervisorVmValidationResponseModel) Get() *CollectionModelOfHypervisorVmValidationResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfHypervisorVmValidationResponseModel) Set(val *CollectionModelOfHypervisorVmValidationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfHypervisorVmValidationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfHypervisorVmValidationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfHypervisorVmValidationResponseModel(val *CollectionModelOfHypervisorVmValidationResponseModel) *NullableCollectionModelOfHypervisorVmValidationResponseModel {
	return &NullableCollectionModelOfHypervisorVmValidationResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfHypervisorVmValidationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfHypervisorVmValidationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
