...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		Servers:          ServerConfigurations{
			...
			{
				URL: "https://api-eu.cloud.com/cvad/manage",
				Description: "For customers in EU region",
			},
			{
				URL: "https://api-ap-s.cloud.com/cvad/manage",
				Description: "For customers in AP-S region",
			},
			{
				URL: "https://api.citrixcloud.jp/cvad/manage",
