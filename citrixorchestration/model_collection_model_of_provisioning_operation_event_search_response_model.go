...
// checks if the CollectionModelOfProvisioningOperationEventSearchResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisioningOperationEventSearchResponseModel{}

// CollectionModelOfProvisioningOperationEventSearchResponseModel Response object for collections of items.
type CollectionModelOfProvisioningOperationEventSearchResponseModel struct {
	// List of items.
...
type _CollectionModelOfProvisioningOperationEventSearchResponseModel CollectionModelOfProvisioningOperationEventSearchResponseModel
...
func NewCollectionModelOfProvisioningOperationEventSearchResponseModel(items []ProvisioningOperationEventSearchResponseModel) *CollectionModelOfProvisioningOperationEventSearchResponseModel {
	this := CollectionModelOfProvisioningOperationEventSearchResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisioningOperationEventSearchResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisioningOperationEventSearchResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisioningOperationEventSearchResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisioningOperationEventSearchResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisioningOperationEventSearchResponseModel struct {
	value *CollectionModelOfProvisioningOperationEventSearchResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) Get() *CollectionModelOfProvisioningOperationEventSearchResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) Set(val *CollectionModelOfProvisioningOperationEventSearchResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisioningOperationEventSearchResponseModel(val *CollectionModelOfProvisioningOperationEventSearchResponseModel) *NullableCollectionModelOfProvisioningOperationEventSearchResponseModel {
	return &NullableCollectionModelOfProvisioningOperationEventSearchResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisioningOperationEventSearchResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
