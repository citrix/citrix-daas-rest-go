...
// checks if the HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone{}

// HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone Availability zone.
type HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone struct {
	// Id of the resource.
...
func NewHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone() *HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone {
	this := HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone{}
	return &this
}
...
func (o HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone struct {
	value *HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone
	isSet bool
}

func (v NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) Get() *HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone {
	return v.value
}

func (v *NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) Set(val *HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone(val *HypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) *NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone {
	return &NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolAWSDetailResponseModelAllOfAvailabilityZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
