...
// checks if the IdentityPrinterResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityPrinterResponseModelCollection{}

// IdentityPrinterResponseModelCollection struct for IdentityPrinterResponseModelCollection
type IdentityPrinterResponseModelCollection struct {
	// List of items.
...
type _IdentityPrinterResponseModelCollection IdentityPrinterResponseModelCollection
...
func NewIdentityPrinterResponseModelCollection(items []IdentityPrinterResponseModel) *IdentityPrinterResponseModelCollection {
	this := IdentityPrinterResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *IdentityPrinterResponseModelCollection) SetContinuationTokenNil() {
...
func (o *IdentityPrinterResponseModelCollection) SetTotalItemsNil() {
...
func (o IdentityPrinterResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o IdentityPrinterResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableIdentityPrinterResponseModelCollection struct {
	value *IdentityPrinterResponseModelCollection
	isSet bool
}

func (v NullableIdentityPrinterResponseModelCollection) Get() *IdentityPrinterResponseModelCollection {
	return v.value
}

func (v *NullableIdentityPrinterResponseModelCollection) Set(val *IdentityPrinterResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityPrinterResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityPrinterResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityPrinterResponseModelCollection(val *IdentityPrinterResponseModelCollection) *NullableIdentityPrinterResponseModelCollection {
	return &NullableIdentityPrinterResponseModelCollection{value: val, isSet: true}
}

func (v NullableIdentityPrinterResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityPrinterResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
