...
type ProvisioningSchemeResponseModel struct {
	...
	ImageRuntimeInfo *ImageRuntimeInfoResponseModel `json:"ImageRuntimeInfo,omitempty"`
...
func (o *ProvisioningSchemeResponseModel) GetImageRuntimeInfo() ImageRuntimeInfoResponseModel {
	if o == nil || IsNil(o.ImageRuntimeInfo) {
		var ret ImageRuntimeInfoResponseModel
		return ret
	}
...
// SetImageRuntimeInfo gets a reference to the given ImageRuntimeInfoResponseModel and assigns it to the ImageRuntimeInfo field.
