...
// checks if the CollectionModelOfImportProvisionedVirtualMachineResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfImportProvisionedVirtualMachineResponseModel{}

// CollectionModelOfImportProvisionedVirtualMachineResponseModel Response object for collections of items.
type CollectionModelOfImportProvisionedVirtualMachineResponseModel struct {
	// List of items.
	Items []ImportProvisionedVirtualMachineResponseModel `json:"Items"`
...
type _CollectionModelOfImportProvisionedVirtualMachineResponseModel CollectionModelOfImportProvisionedVirtualMachineResponseModel
...
func NewCollectionModelOfImportProvisionedVirtualMachineResponseModel(items []ImportProvisionedVirtualMachineResponseModel) *CollectionModelOfImportProvisionedVirtualMachineResponseModel {
	this := CollectionModelOfImportProvisionedVirtualMachineResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfImportProvisionedVirtualMachineResponseModel) GetItems() []ImportProvisionedVirtualMachineResponseModel {
	if o == nil {
		var ret []ImportProvisionedVirtualMachineResponseModel
		return ret
	}
...
func (o *CollectionModelOfImportProvisionedVirtualMachineResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfImportProvisionedVirtualMachineResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfImportProvisionedVirtualMachineResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfImportProvisionedVirtualMachineResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel struct {
	value *CollectionModelOfImportProvisionedVirtualMachineResponseModel
	isSet bool
}

func (v NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) Get() *CollectionModelOfImportProvisionedVirtualMachineResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) Set(val *CollectionModelOfImportProvisionedVirtualMachineResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfImportProvisionedVirtualMachineResponseModel(val *CollectionModelOfImportProvisionedVirtualMachineResponseModel) *NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel {
	return &NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfImportProvisionedVirtualMachineResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
