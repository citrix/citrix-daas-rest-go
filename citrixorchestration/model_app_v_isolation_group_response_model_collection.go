...
// checks if the AppVIsolationGroupResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVIsolationGroupResponseModelCollection{}

// AppVIsolationGroupResponseModelCollection struct for AppVIsolationGroupResponseModelCollection
type AppVIsolationGroupResponseModelCollection struct {
	// List of items.
...
type _AppVIsolationGroupResponseModelCollection AppVIsolationGroupResponseModelCollection
...
func NewAppVIsolationGroupResponseModelCollection(items []AppVIsolationGroupResponseModel) *AppVIsolationGroupResponseModelCollection {
	this := AppVIsolationGroupResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AppVIsolationGroupResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AppVIsolationGroupResponseModelCollection) SetTotalItemsNil() {
...
func (o AppVIsolationGroupResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AppVIsolationGroupResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAppVIsolationGroupResponseModelCollection struct {
	value *AppVIsolationGroupResponseModelCollection
	isSet bool
}

func (v NullableAppVIsolationGroupResponseModelCollection) Get() *AppVIsolationGroupResponseModelCollection {
	return v.value
}

func (v *NullableAppVIsolationGroupResponseModelCollection) Set(val *AppVIsolationGroupResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVIsolationGroupResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVIsolationGroupResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVIsolationGroupResponseModelCollection(val *AppVIsolationGroupResponseModelCollection) *NullableAppVIsolationGroupResponseModelCollection {
	return &NullableAppVIsolationGroupResponseModelCollection{value: val, isSet: true}
}

func (v NullableAppVIsolationGroupResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVIsolationGroupResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
