...
// checks if the CollectionModelOfIdentitySiteResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfIdentitySiteResponseModel{}

// CollectionModelOfIdentitySiteResponseModel Response object for collections of items.
type CollectionModelOfIdentitySiteResponseModel struct {
	// List of items.
...
type _CollectionModelOfIdentitySiteResponseModel CollectionModelOfIdentitySiteResponseModel
...
func NewCollectionModelOfIdentitySiteResponseModel(items []IdentitySiteResponseModel) *CollectionModelOfIdentitySiteResponseModel {
	this := CollectionModelOfIdentitySiteResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfIdentitySiteResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfIdentitySiteResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfIdentitySiteResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfIdentitySiteResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfIdentitySiteResponseModel struct {
	value *CollectionModelOfIdentitySiteResponseModel
	isSet bool
}

func (v NullableCollectionModelOfIdentitySiteResponseModel) Get() *CollectionModelOfIdentitySiteResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfIdentitySiteResponseModel) Set(val *CollectionModelOfIdentitySiteResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfIdentitySiteResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfIdentitySiteResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfIdentitySiteResponseModel(val *CollectionModelOfIdentitySiteResponseModel) *NullableCollectionModelOfIdentitySiteResponseModel {
	return &NullableCollectionModelOfIdentitySiteResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfIdentitySiteResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfIdentitySiteResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
