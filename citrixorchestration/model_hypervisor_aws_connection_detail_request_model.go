...
// checks if the HypervisorAWSConnectionDetailRequestModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorAWSConnectionDetailRequestModel{}

// HypervisorAWSConnectionDetailRequestModel struct for HypervisorAWSConnectionDetailRequestModel
type HypervisorAWSConnectionDetailRequestModel struct {
...
func NewHypervisorAWSConnectionDetailRequestModel(name string, connectionType HypervisorConnectionType, apiKey string, secretKey string) *HypervisorAWSConnectionDetailRequestModel {
	this := HypervisorAWSConnectionDetailRequestModel{}
	this.Name = name
...
func (o HypervisorAWSConnectionDetailRequestModel) MarshalJSON() ([]byte, error) {
...
func (o HypervisorAWSConnectionDetailRequestModel) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorAWSConnectionDetailRequestModel struct {
	value *HypervisorAWSConnectionDetailRequestModel
	isSet bool
}

func (v NullableHypervisorAWSConnectionDetailRequestModel) Get() *HypervisorAWSConnectionDetailRequestModel {
	return v.value
}

func (v *NullableHypervisorAWSConnectionDetailRequestModel) Set(val *HypervisorAWSConnectionDetailRequestModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorAWSConnectionDetailRequestModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorAWSConnectionDetailRequestModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorAWSConnectionDetailRequestModel(val *HypervisorAWSConnectionDetailRequestModel) *NullableHypervisorAWSConnectionDetailRequestModel {
	return &NullableHypervisorAWSConnectionDetailRequestModel{value: val, isSet: true}
}

func (v NullableHypervisorAWSConnectionDetailRequestModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorAWSConnectionDetailRequestModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
