...
// checks if the CollectionModelOfStartMenuApplicationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfStartMenuApplicationResponseModel{}

// CollectionModelOfStartMenuApplicationResponseModel Response object for collections of items.
type CollectionModelOfStartMenuApplicationResponseModel struct {
	// List of items.
...
type _CollectionModelOfStartMenuApplicationResponseModel CollectionModelOfStartMenuApplicationResponseModel
...
func NewCollectionModelOfStartMenuApplicationResponseModel(items []StartMenuApplicationResponseModel) *CollectionModelOfStartMenuApplicationResponseModel {
	this := CollectionModelOfStartMenuApplicationResponseModel{}
	this.Items = items
	return &this
}
...
func (o CollectionModelOfStartMenuApplicationResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfStartMenuApplicationResponseModel struct {
	value *CollectionModelOfStartMenuApplicationResponseModel
	isSet bool
}

func (v NullableCollectionModelOfStartMenuApplicationResponseModel) Get() *CollectionModelOfStartMenuApplicationResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfStartMenuApplicationResponseModel) Set(val *CollectionModelOfStartMenuApplicationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfStartMenuApplicationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfStartMenuApplicationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfStartMenuApplicationResponseModel(val *CollectionModelOfStartMenuApplicationResponseModel) *NullableCollectionModelOfStartMenuApplicationResponseModel {
	return &NullableCollectionModelOfStartMenuApplicationResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfStartMenuApplicationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfStartMenuApplicationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
