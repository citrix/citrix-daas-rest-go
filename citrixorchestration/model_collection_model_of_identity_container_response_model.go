...
// checks if the CollectionModelOfIdentityContainerResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfIdentityContainerResponseModel{}

// CollectionModelOfIdentityContainerResponseModel Response object for collections of items.
type CollectionModelOfIdentityContainerResponseModel struct {
	// List of items.
...
type _CollectionModelOfIdentityContainerResponseModel CollectionModelOfIdentityContainerResponseModel
...
func NewCollectionModelOfIdentityContainerResponseModel(items []IdentityContainerResponseModel) *CollectionModelOfIdentityContainerResponseModel {
	this := CollectionModelOfIdentityContainerResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfIdentityContainerResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfIdentityContainerResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfIdentityContainerResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfIdentityContainerResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfIdentityContainerResponseModel struct {
	value *CollectionModelOfIdentityContainerResponseModel
	isSet bool
}

func (v NullableCollectionModelOfIdentityContainerResponseModel) Get() *CollectionModelOfIdentityContainerResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfIdentityContainerResponseModel) Set(val *CollectionModelOfIdentityContainerResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfIdentityContainerResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfIdentityContainerResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfIdentityContainerResponseModel(val *CollectionModelOfIdentityContainerResponseModel) *NullableCollectionModelOfIdentityContainerResponseModel {
	return &NullableCollectionModelOfIdentityContainerResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfIdentityContainerResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfIdentityContainerResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
