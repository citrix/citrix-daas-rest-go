...
// checks if the CollectionModelOfDeliveryGroupResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfDeliveryGroupResponseModel{}

// CollectionModelOfDeliveryGroupResponseModel Response object for collections of items.
type CollectionModelOfDeliveryGroupResponseModel struct {
	// List of items.
	Items []DeliveryGroupResponseModel `json:"Items"`
...
func NewCollectionModelOfDeliveryGroupResponseModel(items []DeliveryGroupResponseModel) *CollectionModelOfDeliveryGroupResponseModel {
	this := CollectionModelOfDeliveryGroupResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfDeliveryGroupResponseModel) GetItems() []DeliveryGroupResponseModel {
	if o == nil {
		var ret []DeliveryGroupResponseModel
		return ret
	}
...
func (o *CollectionModelOfDeliveryGroupResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfDeliveryGroupResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfDeliveryGroupResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfDeliveryGroupResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfDeliveryGroupResponseModel struct {
	value *CollectionModelOfDeliveryGroupResponseModel
	isSet bool
}

func (v NullableCollectionModelOfDeliveryGroupResponseModel) Get() *CollectionModelOfDeliveryGroupResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfDeliveryGroupResponseModel) Set(val *CollectionModelOfDeliveryGroupResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfDeliveryGroupResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfDeliveryGroupResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfDeliveryGroupResponseModel(val *CollectionModelOfDeliveryGroupResponseModel) *NullableCollectionModelOfDeliveryGroupResponseModel {
	return &NullableCollectionModelOfDeliveryGroupResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfDeliveryGroupResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfDeliveryGroupResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
