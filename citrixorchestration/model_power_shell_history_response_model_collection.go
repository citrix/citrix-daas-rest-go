...
// checks if the PowerShellHistoryResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PowerShellHistoryResponseModelCollection{}

// PowerShellHistoryResponseModelCollection struct for PowerShellHistoryResponseModelCollection
type PowerShellHistoryResponseModelCollection struct {
	// List of items.
...
type _PowerShellHistoryResponseModelCollection PowerShellHistoryResponseModelCollection
...
func NewPowerShellHistoryResponseModelCollection(items []PowerShellHistoryResponseModel) *PowerShellHistoryResponseModelCollection {
	this := PowerShellHistoryResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o PowerShellHistoryResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePowerShellHistoryResponseModelCollection struct {
	value *PowerShellHistoryResponseModelCollection
	isSet bool
}

func (v NullablePowerShellHistoryResponseModelCollection) Get() *PowerShellHistoryResponseModelCollection {
	return v.value
}

func (v *NullablePowerShellHistoryResponseModelCollection) Set(val *PowerShellHistoryResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePowerShellHistoryResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePowerShellHistoryResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePowerShellHistoryResponseModelCollection(val *PowerShellHistoryResponseModelCollection) *NullablePowerShellHistoryResponseModelCollection {
	return &NullablePowerShellHistoryResponseModelCollection{value: val, isSet: true}
}

func (v NullablePowerShellHistoryResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePowerShellHistoryResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
