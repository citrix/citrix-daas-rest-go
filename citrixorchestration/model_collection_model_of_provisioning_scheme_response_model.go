...
// checks if the CollectionModelOfProvisioningSchemeResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfProvisioningSchemeResponseModel{}

// CollectionModelOfProvisioningSchemeResponseModel Response object for collections of items.
type CollectionModelOfProvisioningSchemeResponseModel struct {
	// List of items.
...
type _CollectionModelOfProvisioningSchemeResponseModel CollectionModelOfProvisioningSchemeResponseModel
...
func NewCollectionModelOfProvisioningSchemeResponseModel(items []ProvisioningSchemeResponseModel) *CollectionModelOfProvisioningSchemeResponseModel {
	this := CollectionModelOfProvisioningSchemeResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfProvisioningSchemeResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfProvisioningSchemeResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfProvisioningSchemeResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfProvisioningSchemeResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfProvisioningSchemeResponseModel struct {
	value *CollectionModelOfProvisioningSchemeResponseModel
	isSet bool
}

func (v NullableCollectionModelOfProvisioningSchemeResponseModel) Get() *CollectionModelOfProvisioningSchemeResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfProvisioningSchemeResponseModel) Set(val *CollectionModelOfProvisioningSchemeResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfProvisioningSchemeResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfProvisioningSchemeResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfProvisioningSchemeResponseModel(val *CollectionModelOfProvisioningSchemeResponseModel) *NullableCollectionModelOfProvisioningSchemeResponseModel {
	return &NullableCollectionModelOfProvisioningSchemeResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfProvisioningSchemeResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfProvisioningSchemeResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
