...
// checks if the CollectionModelOfAppVServerResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfAppVServerResponseModel{}

// CollectionModelOfAppVServerResponseModel Response object for collections of items.
type CollectionModelOfAppVServerResponseModel struct {
	// List of items.
	Items []AppVServerResponseModel `json:"Items"`
...
type _CollectionModelOfAppVServerResponseModel CollectionModelOfAppVServerResponseModel
...
func NewCollectionModelOfAppVServerResponseModel(items []AppVServerResponseModel) *CollectionModelOfAppVServerResponseModel {
	this := CollectionModelOfAppVServerResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfAppVServerResponseModel) GetItems() []AppVServerResponseModel {
	if o == nil {
		var ret []AppVServerResponseModel
		return ret
	}
...
func (o *CollectionModelOfAppVServerResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfAppVServerResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfAppVServerResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfAppVServerResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfAppVServerResponseModel struct {
	value *CollectionModelOfAppVServerResponseModel
	isSet bool
}

func (v NullableCollectionModelOfAppVServerResponseModel) Get() *CollectionModelOfAppVServerResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfAppVServerResponseModel) Set(val *CollectionModelOfAppVServerResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfAppVServerResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfAppVServerResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfAppVServerResponseModel(val *CollectionModelOfAppVServerResponseModel) *NullableCollectionModelOfAppVServerResponseModel {
	return &NullableCollectionModelOfAppVServerResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfAppVServerResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfAppVServerResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
