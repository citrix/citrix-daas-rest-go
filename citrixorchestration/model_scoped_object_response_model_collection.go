...
// checks if the ScopedObjectResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScopedObjectResponseModelCollection{}

// ScopedObjectResponseModelCollection struct for ScopedObjectResponseModelCollection
type ScopedObjectResponseModelCollection struct {
	// List of items.
...
type _ScopedObjectResponseModelCollection ScopedObjectResponseModelCollection
...
func NewScopedObjectResponseModelCollection(items []ScopedObjectResponseModel) *ScopedObjectResponseModelCollection {
	this := ScopedObjectResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ScopedObjectResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ScopedObjectResponseModelCollection) SetTotalItemsNil() {
...
func (o ScopedObjectResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ScopedObjectResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableScopedObjectResponseModelCollection struct {
	value *ScopedObjectResponseModelCollection
	isSet bool
}

func (v NullableScopedObjectResponseModelCollection) Get() *ScopedObjectResponseModelCollection {
	return v.value
}

func (v *NullableScopedObjectResponseModelCollection) Set(val *ScopedObjectResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableScopedObjectResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableScopedObjectResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScopedObjectResponseModelCollection(val *ScopedObjectResponseModelCollection) *NullableScopedObjectResponseModelCollection {
	return &NullableScopedObjectResponseModelCollection{value: val, isSet: true}
}

func (v NullableScopedObjectResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScopedObjectResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
