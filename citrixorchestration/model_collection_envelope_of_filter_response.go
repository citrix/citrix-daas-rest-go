...
// CollectionEnvelopeOfFilterResponse See: https://code.citrite.net/projects/APIPF/repos/api-guidelines/browse/rest/collections.md Response object for collections of items. Should be the same as TP\\CollectionModel.cs. But that definition doesn't use camel casing.
