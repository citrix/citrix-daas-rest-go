...
// GetSettingDefinitions returns the SettingDefinitions field value if set, zero value otherwise.
...
// GetFilterDefinitions returns the FilterDefinitions field value if set, zero value otherwise.
...
func (o AllResponseContract) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SettingDefinitions) {
		toSerialize["SettingDefinitions"] = o.SettingDefinitions
	}
	if !IsNil(o.FilterDefinitions) {
