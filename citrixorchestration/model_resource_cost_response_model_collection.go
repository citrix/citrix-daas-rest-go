...
// checks if the ResourceCostResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceCostResponseModelCollection{}

// ResourceCostResponseModelCollection struct for ResourceCostResponseModelCollection
type ResourceCostResponseModelCollection struct {
	// List of items.
...
type _ResourceCostResponseModelCollection ResourceCostResponseModelCollection
...
func NewResourceCostResponseModelCollection(items []ResourceCostItemResponseModel) *ResourceCostResponseModelCollection {
	this := ResourceCostResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *ResourceCostResponseModelCollection) SetContinuationTokenNil() {
...
func (o *ResourceCostResponseModelCollection) SetTotalItemsNil() {
...
func (o ResourceCostResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o ResourceCostResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableResourceCostResponseModelCollection struct {
	value *ResourceCostResponseModelCollection
	isSet bool
}

func (v NullableResourceCostResponseModelCollection) Get() *ResourceCostResponseModelCollection {
	return v.value
}

func (v *NullableResourceCostResponseModelCollection) Set(val *ResourceCostResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceCostResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceCostResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceCostResponseModelCollection(val *ResourceCostResponseModelCollection) *NullableResourceCostResponseModelCollection {
	return &NullableResourceCostResponseModelCollection{value: val, isSet: true}
}

func (v NullableResourceCostResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceCostResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
