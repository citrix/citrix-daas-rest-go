...
// checks if the CollectionModelOfMachineCatalogResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfMachineCatalogResponseModel{}

// CollectionModelOfMachineCatalogResponseModel Response object for collections of items.
type CollectionModelOfMachineCatalogResponseModel struct {
	// List of items.
...
type _CollectionModelOfMachineCatalogResponseModel CollectionModelOfMachineCatalogResponseModel
...
func NewCollectionModelOfMachineCatalogResponseModel(items []MachineCatalogResponseModel) *CollectionModelOfMachineCatalogResponseModel {
	this := CollectionModelOfMachineCatalogResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfMachineCatalogResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfMachineCatalogResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfMachineCatalogResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfMachineCatalogResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfMachineCatalogResponseModel struct {
	value *CollectionModelOfMachineCatalogResponseModel
	isSet bool
}

func (v NullableCollectionModelOfMachineCatalogResponseModel) Get() *CollectionModelOfMachineCatalogResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfMachineCatalogResponseModel) Set(val *CollectionModelOfMachineCatalogResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfMachineCatalogResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfMachineCatalogResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfMachineCatalogResponseModel(val *CollectionModelOfMachineCatalogResponseModel) *NullableCollectionModelOfMachineCatalogResponseModel {
	return &NullableCollectionModelOfMachineCatalogResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfMachineCatalogResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfMachineCatalogResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
