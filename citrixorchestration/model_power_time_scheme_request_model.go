...
func NewPowerTimeSchemeRequestModel() *PowerTimeSchemeRequestModel {
	...
	this.PoolUsingPercentage = &poolUsingPercentage
	return &this
}
...
// GetPeakTimeRanges returns the PeakTimeRanges field value if set, zero value otherwise.
...
// GetPoolSizeSchedule returns the PoolSizeSchedule field value if set, zero value otherwise.
