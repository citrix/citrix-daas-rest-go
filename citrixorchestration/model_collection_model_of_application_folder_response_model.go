...
// checks if the CollectionModelOfApplicationFolderResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfApplicationFolderResponseModel{}

// CollectionModelOfApplicationFolderResponseModel Response object for collections of items.
type CollectionModelOfApplicationFolderResponseModel struct {
	// List of items.
...
type _CollectionModelOfApplicationFolderResponseModel CollectionModelOfApplicationFolderResponseModel
...
func NewCollectionModelOfApplicationFolderResponseModel(items []ApplicationFolderResponseModel) *CollectionModelOfApplicationFolderResponseModel {
	this := CollectionModelOfApplicationFolderResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfApplicationFolderResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfApplicationFolderResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfApplicationFolderResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfApplicationFolderResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfApplicationFolderResponseModel struct {
	value *CollectionModelOfApplicationFolderResponseModel
	isSet bool
}

func (v NullableCollectionModelOfApplicationFolderResponseModel) Get() *CollectionModelOfApplicationFolderResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfApplicationFolderResponseModel) Set(val *CollectionModelOfApplicationFolderResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfApplicationFolderResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfApplicationFolderResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfApplicationFolderResponseModel(val *CollectionModelOfApplicationFolderResponseModel) *NullableCollectionModelOfApplicationFolderResponseModel {
	return &NullableCollectionModelOfApplicationFolderResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfApplicationFolderResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfApplicationFolderResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
