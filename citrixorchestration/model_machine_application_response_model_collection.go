...
// checks if the MachineApplicationResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MachineApplicationResponseModelCollection{}

// MachineApplicationResponseModelCollection struct for MachineApplicationResponseModelCollection
type MachineApplicationResponseModelCollection struct {
	// List of items.
...
type _MachineApplicationResponseModelCollection MachineApplicationResponseModelCollection
...
func NewMachineApplicationResponseModelCollection(items []MachineApplicationResponseModel) *MachineApplicationResponseModelCollection {
	this := MachineApplicationResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *MachineApplicationResponseModelCollection) SetContinuationTokenNil() {
...
func (o *MachineApplicationResponseModelCollection) SetTotalItemsNil() {
...
func (o MachineApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o MachineApplicationResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableMachineApplicationResponseModelCollection struct {
	value *MachineApplicationResponseModelCollection
	isSet bool
}

func (v NullableMachineApplicationResponseModelCollection) Get() *MachineApplicationResponseModelCollection {
	return v.value
}

func (v *NullableMachineApplicationResponseModelCollection) Set(val *MachineApplicationResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableMachineApplicationResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableMachineApplicationResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMachineApplicationResponseModelCollection(val *MachineApplicationResponseModelCollection) *NullableMachineApplicationResponseModelCollection {
	return &NullableMachineApplicationResponseModelCollection{value: val, isSet: true}
}

func (v NullableMachineApplicationResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMachineApplicationResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
