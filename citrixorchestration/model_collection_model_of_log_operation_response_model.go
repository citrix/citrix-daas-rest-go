...
// checks if the CollectionModelOfLogOperationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfLogOperationResponseModel{}

// CollectionModelOfLogOperationResponseModel Response object for collections of items.
type CollectionModelOfLogOperationResponseModel struct {
	// List of items.
	Items []LogOperationResponseModel `json:"Items"`
...
type _CollectionModelOfLogOperationResponseModel CollectionModelOfLogOperationResponseModel
...
func NewCollectionModelOfLogOperationResponseModel(items []LogOperationResponseModel) *CollectionModelOfLogOperationResponseModel {
	this := CollectionModelOfLogOperationResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfLogOperationResponseModel) GetItems() []LogOperationResponseModel {
	if o == nil {
		var ret []LogOperationResponseModel
		return ret
	}
...
func (o *CollectionModelOfLogOperationResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfLogOperationResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfLogOperationResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfLogOperationResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfLogOperationResponseModel struct {
	value *CollectionModelOfLogOperationResponseModel
	isSet bool
}

func (v NullableCollectionModelOfLogOperationResponseModel) Get() *CollectionModelOfLogOperationResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfLogOperationResponseModel) Set(val *CollectionModelOfLogOperationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfLogOperationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfLogOperationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfLogOperationResponseModel(val *CollectionModelOfLogOperationResponseModel) *NullableCollectionModelOfLogOperationResponseModel {
	return &NullableCollectionModelOfLogOperationResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfLogOperationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfLogOperationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
