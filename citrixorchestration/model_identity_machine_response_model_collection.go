...
// checks if the IdentityMachineResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityMachineResponseModelCollection{}

// IdentityMachineResponseModelCollection struct for IdentityMachineResponseModelCollection
type IdentityMachineResponseModelCollection struct {
	// List of items.
...
func NewIdentityMachineResponseModelCollection(items []IdentityMachineResponseModel) *IdentityMachineResponseModelCollection {
	this := IdentityMachineResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *IdentityMachineResponseModelCollection) SetContinuationTokenNil() {
...
func (o *IdentityMachineResponseModelCollection) SetTotalItemsNil() {
...
func (o IdentityMachineResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o IdentityMachineResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableIdentityMachineResponseModelCollection struct {
	value *IdentityMachineResponseModelCollection
	isSet bool
}

func (v NullableIdentityMachineResponseModelCollection) Get() *IdentityMachineResponseModelCollection {
	return v.value
}

func (v *NullableIdentityMachineResponseModelCollection) Set(val *IdentityMachineResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityMachineResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityMachineResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityMachineResponseModelCollection(val *IdentityMachineResponseModelCollection) *NullableIdentityMachineResponseModelCollection {
	return &NullableIdentityMachineResponseModelCollection{value: val, isSet: true}
}

func (v NullableIdentityMachineResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityMachineResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
