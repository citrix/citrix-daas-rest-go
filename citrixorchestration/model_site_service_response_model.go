...
// GetCurrentSchemaVersion returns the CurrentSchemaVersion field value if set, zero value otherwise.
func (o *SiteServiceResponseModel) GetCurrentSchemaVersion() string {
	if o == nil || IsNil(o.CurrentSchemaVersion) {
		var ret string
		return ret
	}
	return *o.CurrentSchemaVersion
}
...
func (o *SiteServiceResponseModel) GetCurrentSchemaVersionOk() (*string, bool) {
	...
	return o.CurrentSchemaVersion, true
}
...
// SetCurrentSchemaVersion gets a reference to the given string and assigns it to the CurrentSchemaVersion field.
func (o *SiteServiceResponseModel) SetCurrentSchemaVersion(v string) {
	o.CurrentSchemaVersion = &v
}

// GetDesiredSchemaVersion returns the DesiredSchemaVersion field value if set, zero value otherwise.
func (o *SiteServiceResponseModel) GetDesiredSchemaVersion() string {
	if o == nil || IsNil(o.DesiredSchemaVersion) {
		var ret string
		return ret
	}
	return *o.DesiredSchemaVersion
}
...
func (o *SiteServiceResponseModel) GetDesiredSchemaVersionOk() (*string, bool) {
	...
	return o.DesiredSchemaVersion, true
}
...
// SetDesiredSchemaVersion gets a reference to the given string and assigns it to the DesiredSchemaVersion field.
func (o *SiteServiceResponseModel) SetDesiredSchemaVersion(v string) {
	o.DesiredSchemaVersion = &v
}
...
func (o SiteServiceResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CurrentSchemaVersion) {
		toSerialize["CurrentSchemaVersion"] = o.CurrentSchemaVersion
	}
	if !IsNil(o.DesiredSchemaVersion) {
		toSerialize["DesiredSchemaVersion"] = o.DesiredSchemaVersion
	}
