...
// checks if the CollectionModelOfDatabaseResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfDatabaseResponseModel{}

// CollectionModelOfDatabaseResponseModel Response object for collections of items.
type CollectionModelOfDatabaseResponseModel struct {
	// List of items.
...
type _CollectionModelOfDatabaseResponseModel CollectionModelOfDatabaseResponseModel
...
func NewCollectionModelOfDatabaseResponseModel(items []DatabaseResponseModel) *CollectionModelOfDatabaseResponseModel {
	this := CollectionModelOfDatabaseResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfDatabaseResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfDatabaseResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfDatabaseResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfDatabaseResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfDatabaseResponseModel struct {
	value *CollectionModelOfDatabaseResponseModel
	isSet bool
}

func (v NullableCollectionModelOfDatabaseResponseModel) Get() *CollectionModelOfDatabaseResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfDatabaseResponseModel) Set(val *CollectionModelOfDatabaseResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfDatabaseResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfDatabaseResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfDatabaseResponseModel(val *CollectionModelOfDatabaseResponseModel) *NullableCollectionModelOfDatabaseResponseModel {
	return &NullableCollectionModelOfDatabaseResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfDatabaseResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfDatabaseResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
