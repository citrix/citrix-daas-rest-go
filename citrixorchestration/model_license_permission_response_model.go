...
type LicensePermissionResponseModel struct {
	...
	LicensingAdministrator *string `json:"LicensingAdministrator,omitempty"`
...
// GetLicensingAdministrator returns the LicensingAdministrator field value if set, zero value otherwise.
func (o *LicensePermissionResponseModel) GetLicensingAdministrator() string {
	if o == nil || IsNil(o.LicensingAdministrator) {
		var ret string
		return ret
	}
	return *o.LicensingAdministrator
}
...
func (o *LicensePermissionResponseModel) GetLicensingAdministratorOk() (*string, bool) {
	...
	return o.LicensingAdministrator, true
}
...
// SetLicensingAdministrator gets a reference to the given string and assigns it to the LicensingAdministrator field.
func (o *LicensePermissionResponseModel) SetLicensingAdministrator(v string) {
	o.LicensingAdministrator = &v
}
...
func (o LicensePermissionResponseModel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LicensingAdministrator) {
		toSerialize["LicensingAdministrator"] = o.LicensingAdministrator
	}
