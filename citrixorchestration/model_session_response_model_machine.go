...
// checks if the SessionResponseModelMachine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionResponseModelMachine{}

// SessionResponseModelMachine The machine on which the session is hosted.
type SessionResponseModelMachine struct {
...
func NewSessionResponseModelMachine(id string, inMaintenanceMode bool, drainingUntilShutdown bool, machineType MachineType, powerState PowerState, provisioningType ProvisioningType, sessionSupport SessionSupport, sid string, summaryState SummaryState, zone MachineResponseModelAllOfZone, faultState FaultState) *SessionResponseModelMachine {
	this := SessionResponseModelMachine{}
	this.Id = id
...
func (o SessionResponseModelMachine) MarshalJSON() ([]byte, error) {
...
func (o SessionResponseModelMachine) ToMap() (map[string]interface{}, error) {
...
type NullableSessionResponseModelMachine struct {
	value *SessionResponseModelMachine
	isSet bool
}

func (v NullableSessionResponseModelMachine) Get() *SessionResponseModelMachine {
	return v.value
}

func (v *NullableSessionResponseModelMachine) Set(val *SessionResponseModelMachine) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionResponseModelMachine) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionResponseModelMachine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionResponseModelMachine(val *SessionResponseModelMachine) *NullableSessionResponseModelMachine {
	return &NullableSessionResponseModelMachine{value: val, isSet: true}
}

func (v NullableSessionResponseModelMachine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionResponseModelMachine) UnmarshalJSON(src []byte) error {
	v.isSet = true
