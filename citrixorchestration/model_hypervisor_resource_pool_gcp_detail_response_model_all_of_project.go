...
// checks if the HypervisorResourcePoolGcpDetailResponseModelAllOfProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorResourcePoolGcpDetailResponseModelAllOfProject{}

// HypervisorResourcePoolGcpDetailResponseModelAllOfProject Google Cloud Platform project which the resource pool is connected to.
type HypervisorResourcePoolGcpDetailResponseModelAllOfProject struct {
	// Id of the resource.
...
func NewHypervisorResourcePoolGcpDetailResponseModelAllOfProject() *HypervisorResourcePoolGcpDetailResponseModelAllOfProject {
	this := HypervisorResourcePoolGcpDetailResponseModelAllOfProject{}
	return &this
}
...
func (o HypervisorResourcePoolGcpDetailResponseModelAllOfProject) MarshalJSON() ([]byte, error) {
...
func (o HypervisorResourcePoolGcpDetailResponseModelAllOfProject) ToMap() (map[string]interface{}, error) {
...
type NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject struct {
	value *HypervisorResourcePoolGcpDetailResponseModelAllOfProject
	isSet bool
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) Get() *HypervisorResourcePoolGcpDetailResponseModelAllOfProject {
	return v.value
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) Set(val *HypervisorResourcePoolGcpDetailResponseModelAllOfProject) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject(val *HypervisorResourcePoolGcpDetailResponseModelAllOfProject) *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject {
	return &NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject{value: val, isSet: true}
}

func (v NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorResourcePoolGcpDetailResponseModelAllOfProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
