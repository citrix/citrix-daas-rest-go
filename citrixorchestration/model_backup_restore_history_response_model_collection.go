...
// checks if the BackupRestoreHistoryResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupRestoreHistoryResponseModelCollection{}

// BackupRestoreHistoryResponseModelCollection struct for BackupRestoreHistoryResponseModelCollection
type BackupRestoreHistoryResponseModelCollection struct {
	// List of items.
...
type _BackupRestoreHistoryResponseModelCollection BackupRestoreHistoryResponseModelCollection
...
func NewBackupRestoreHistoryResponseModelCollection(items []BackupRestoreHistoryInformation) *BackupRestoreHistoryResponseModelCollection {
	this := BackupRestoreHistoryResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *BackupRestoreHistoryResponseModelCollection) SetContinuationTokenNil() {
...
func (o *BackupRestoreHistoryResponseModelCollection) SetTotalItemsNil() {
...
func (o BackupRestoreHistoryResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o BackupRestoreHistoryResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableBackupRestoreHistoryResponseModelCollection struct {
	value *BackupRestoreHistoryResponseModelCollection
	isSet bool
}

func (v NullableBackupRestoreHistoryResponseModelCollection) Get() *BackupRestoreHistoryResponseModelCollection {
	return v.value
}

func (v *NullableBackupRestoreHistoryResponseModelCollection) Set(val *BackupRestoreHistoryResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupRestoreHistoryResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupRestoreHistoryResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupRestoreHistoryResponseModelCollection(val *BackupRestoreHistoryResponseModelCollection) *NullableBackupRestoreHistoryResponseModelCollection {
	return &NullableBackupRestoreHistoryResponseModelCollection{value: val, isSet: true}
}

func (v NullableBackupRestoreHistoryResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupRestoreHistoryResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
