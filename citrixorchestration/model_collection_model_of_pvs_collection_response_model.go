...
// checks if the CollectionModelOfPvsCollectionResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfPvsCollectionResponseModel{}

// CollectionModelOfPvsCollectionResponseModel Response object for collections of items.
type CollectionModelOfPvsCollectionResponseModel struct {
	// List of items.
	Items []PvsCollectionResponseModel `json:"Items"`
...
type _CollectionModelOfPvsCollectionResponseModel CollectionModelOfPvsCollectionResponseModel
...
func NewCollectionModelOfPvsCollectionResponseModel(items []PvsCollectionResponseModel) *CollectionModelOfPvsCollectionResponseModel {
	this := CollectionModelOfPvsCollectionResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfPvsCollectionResponseModel) GetItems() []PvsCollectionResponseModel {
	if o == nil {
		var ret []PvsCollectionResponseModel
		return ret
	}
...
func (o *CollectionModelOfPvsCollectionResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfPvsCollectionResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfPvsCollectionResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfPvsCollectionResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfPvsCollectionResponseModel struct {
	value *CollectionModelOfPvsCollectionResponseModel
	isSet bool
}

func (v NullableCollectionModelOfPvsCollectionResponseModel) Get() *CollectionModelOfPvsCollectionResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfPvsCollectionResponseModel) Set(val *CollectionModelOfPvsCollectionResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfPvsCollectionResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfPvsCollectionResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfPvsCollectionResponseModel(val *CollectionModelOfPvsCollectionResponseModel) *NullableCollectionModelOfPvsCollectionResponseModel {
	return &NullableCollectionModelOfPvsCollectionResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfPvsCollectionResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfPvsCollectionResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
