...
// checks if the CollectionModelOfAutoscalePluginTemplateResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfAutoscalePluginTemplateResponseModel{}

// CollectionModelOfAutoscalePluginTemplateResponseModel Response object for collections of items.
type CollectionModelOfAutoscalePluginTemplateResponseModel struct {
	// List of items.
	Items []AutoscalePluginTemplateResponseModel `json:"Items"`
...
type _CollectionModelOfAutoscalePluginTemplateResponseModel CollectionModelOfAutoscalePluginTemplateResponseModel
...
func NewCollectionModelOfAutoscalePluginTemplateResponseModel(items []AutoscalePluginTemplateResponseModel) *CollectionModelOfAutoscalePluginTemplateResponseModel {
	this := CollectionModelOfAutoscalePluginTemplateResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfAutoscalePluginTemplateResponseModel) GetItems() []AutoscalePluginTemplateResponseModel {
	if o == nil {
		var ret []AutoscalePluginTemplateResponseModel
		return ret
	}
...
func (o *CollectionModelOfAutoscalePluginTemplateResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfAutoscalePluginTemplateResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfAutoscalePluginTemplateResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfAutoscalePluginTemplateResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfAutoscalePluginTemplateResponseModel struct {
	value *CollectionModelOfAutoscalePluginTemplateResponseModel
	isSet bool
}

func (v NullableCollectionModelOfAutoscalePluginTemplateResponseModel) Get() *CollectionModelOfAutoscalePluginTemplateResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfAutoscalePluginTemplateResponseModel) Set(val *CollectionModelOfAutoscalePluginTemplateResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfAutoscalePluginTemplateResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfAutoscalePluginTemplateResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfAutoscalePluginTemplateResponseModel(val *CollectionModelOfAutoscalePluginTemplateResponseModel) *NullableCollectionModelOfAutoscalePluginTemplateResponseModel {
	return &NullableCollectionModelOfAutoscalePluginTemplateResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfAutoscalePluginTemplateResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfAutoscalePluginTemplateResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
