...
// checks if the CollectionModelOfServiceAccountResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfServiceAccountResponseModel{}

// CollectionModelOfServiceAccountResponseModel Response object for collections of items.
type CollectionModelOfServiceAccountResponseModel struct {
	// List of items.
	Items []ServiceAccountResponseModel `json:"Items"`
...
type _CollectionModelOfServiceAccountResponseModel CollectionModelOfServiceAccountResponseModel
...
func NewCollectionModelOfServiceAccountResponseModel(items []ServiceAccountResponseModel) *CollectionModelOfServiceAccountResponseModel {
	this := CollectionModelOfServiceAccountResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfServiceAccountResponseModel) GetItems() []ServiceAccountResponseModel {
	if o == nil {
		var ret []ServiceAccountResponseModel
		return ret
	}
...
func (o *CollectionModelOfServiceAccountResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfServiceAccountResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfServiceAccountResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfServiceAccountResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfServiceAccountResponseModel struct {
	value *CollectionModelOfServiceAccountResponseModel
	isSet bool
}

func (v NullableCollectionModelOfServiceAccountResponseModel) Get() *CollectionModelOfServiceAccountResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfServiceAccountResponseModel) Set(val *CollectionModelOfServiceAccountResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfServiceAccountResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfServiceAccountResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfServiceAccountResponseModel(val *CollectionModelOfServiceAccountResponseModel) *NullableCollectionModelOfServiceAccountResponseModel {
	return &NullableCollectionModelOfServiceAccountResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfServiceAccountResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfServiceAccountResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
