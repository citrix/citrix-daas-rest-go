...
// checks if the CollectionModelOfBackupRestoreScheduleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfBackupRestoreScheduleModel{}

// CollectionModelOfBackupRestoreScheduleModel Response object for collections of items.
type CollectionModelOfBackupRestoreScheduleModel struct {
	// List of items.
...
type _CollectionModelOfBackupRestoreScheduleModel CollectionModelOfBackupRestoreScheduleModel
...
func NewCollectionModelOfBackupRestoreScheduleModel(items []BackupRestoreScheduleModel) *CollectionModelOfBackupRestoreScheduleModel {
	this := CollectionModelOfBackupRestoreScheduleModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfBackupRestoreScheduleModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfBackupRestoreScheduleModel) SetTotalItemsNil() {
...
func (o CollectionModelOfBackupRestoreScheduleModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfBackupRestoreScheduleModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfBackupRestoreScheduleModel struct {
	value *CollectionModelOfBackupRestoreScheduleModel
	isSet bool
}

func (v NullableCollectionModelOfBackupRestoreScheduleModel) Get() *CollectionModelOfBackupRestoreScheduleModel {
	return v.value
}

func (v *NullableCollectionModelOfBackupRestoreScheduleModel) Set(val *CollectionModelOfBackupRestoreScheduleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfBackupRestoreScheduleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfBackupRestoreScheduleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfBackupRestoreScheduleModel(val *CollectionModelOfBackupRestoreScheduleModel) *NullableCollectionModelOfBackupRestoreScheduleModel {
	return &NullableCollectionModelOfBackupRestoreScheduleModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfBackupRestoreScheduleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfBackupRestoreScheduleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
