...
// checks if the SessionResponseModelUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionResponseModelUser{}

// SessionResponseModelUser The session user.
type SessionResponseModelUser struct {
...
func (o SessionResponseModelUser) MarshalJSON() ([]byte, error) {
...
func (o SessionResponseModelUser) ToMap() (map[string]interface{}, error) {
...
type NullableSessionResponseModelUser struct {
	value *SessionResponseModelUser
	isSet bool
}

func (v NullableSessionResponseModelUser) Get() *SessionResponseModelUser {
	return v.value
}

func (v *NullableSessionResponseModelUser) Set(val *SessionResponseModelUser) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionResponseModelUser) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionResponseModelUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionResponseModelUser(val *SessionResponseModelUser) *NullableSessionResponseModelUser {
	return &NullableSessionResponseModelUser{value: val, isSet: true}
}

func (v NullableSessionResponseModelUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionResponseModelUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
