...
// checks if the DesktopUsageResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopUsageResponseModelCollection{}

// DesktopUsageResponseModelCollection struct for DesktopUsageResponseModelCollection
type DesktopUsageResponseModelCollection struct {
	// List of items.
...
type _DesktopUsageResponseModelCollection DesktopUsageResponseModelCollection
...
func NewDesktopUsageResponseModelCollection(items []DesktopUsageResponseModel) *DesktopUsageResponseModelCollection {
	this := DesktopUsageResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *DesktopUsageResponseModelCollection) SetContinuationTokenNil() {
...
func (o *DesktopUsageResponseModelCollection) SetTotalItemsNil() {
...
func (o DesktopUsageResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o DesktopUsageResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopUsageResponseModelCollection struct {
	value *DesktopUsageResponseModelCollection
	isSet bool
}

func (v NullableDesktopUsageResponseModelCollection) Get() *DesktopUsageResponseModelCollection {
	return v.value
}

func (v *NullableDesktopUsageResponseModelCollection) Set(val *DesktopUsageResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopUsageResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopUsageResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopUsageResponseModelCollection(val *DesktopUsageResponseModelCollection) *NullableDesktopUsageResponseModelCollection {
	return &NullableDesktopUsageResponseModelCollection{value: val, isSet: true}
}

func (v NullableDesktopUsageResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopUsageResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
