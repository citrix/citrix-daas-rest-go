...
// checks if the PvsDeviceResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PvsDeviceResponseModelCollection{}

// PvsDeviceResponseModelCollection struct for PvsDeviceResponseModelCollection
type PvsDeviceResponseModelCollection struct {
	// List of items.
...
type _PvsDeviceResponseModelCollection PvsDeviceResponseModelCollection
...
func NewPvsDeviceResponseModelCollection(items []PvsDeviceResponseModel) *PvsDeviceResponseModelCollection {
	this := PvsDeviceResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *PvsDeviceResponseModelCollection) SetContinuationTokenNil() {
...
func (o *PvsDeviceResponseModelCollection) SetTotalItemsNil() {
...
func (o PvsDeviceResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o PvsDeviceResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePvsDeviceResponseModelCollection struct {
	value *PvsDeviceResponseModelCollection
	isSet bool
}

func (v NullablePvsDeviceResponseModelCollection) Get() *PvsDeviceResponseModelCollection {
	return v.value
}

func (v *NullablePvsDeviceResponseModelCollection) Set(val *PvsDeviceResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePvsDeviceResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePvsDeviceResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePvsDeviceResponseModelCollection(val *PvsDeviceResponseModelCollection) *NullablePvsDeviceResponseModelCollection {
	return &NullablePvsDeviceResponseModelCollection{value: val, isSet: true}
}

func (v NullablePvsDeviceResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePvsDeviceResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
