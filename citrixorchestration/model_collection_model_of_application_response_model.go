...
// checks if the CollectionModelOfApplicationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfApplicationResponseModel{}

// CollectionModelOfApplicationResponseModel Response object for collections of items.
type CollectionModelOfApplicationResponseModel struct {
	// List of items.
...
type _CollectionModelOfApplicationResponseModel CollectionModelOfApplicationResponseModel
...
func NewCollectionModelOfApplicationResponseModel(items []ApplicationResponseModel) *CollectionModelOfApplicationResponseModel {
	this := CollectionModelOfApplicationResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfApplicationResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfApplicationResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfApplicationResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfApplicationResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfApplicationResponseModel struct {
	value *CollectionModelOfApplicationResponseModel
	isSet bool
}

func (v NullableCollectionModelOfApplicationResponseModel) Get() *CollectionModelOfApplicationResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfApplicationResponseModel) Set(val *CollectionModelOfApplicationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfApplicationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfApplicationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfApplicationResponseModel(val *CollectionModelOfApplicationResponseModel) *NullableCollectionModelOfApplicationResponseModel {
	return &NullableCollectionModelOfApplicationResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfApplicationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfApplicationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
