...
// checks if the AutoscalePluginTemplateResponseModelCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoscalePluginTemplateResponseModelCollection{}

// AutoscalePluginTemplateResponseModelCollection struct for AutoscalePluginTemplateResponseModelCollection
type AutoscalePluginTemplateResponseModelCollection struct {
	// List of items.
...
type _AutoscalePluginTemplateResponseModelCollection AutoscalePluginTemplateResponseModelCollection
...
func NewAutoscalePluginTemplateResponseModelCollection(items []AutoscalePluginTemplateResponseModel) *AutoscalePluginTemplateResponseModelCollection {
	this := AutoscalePluginTemplateResponseModelCollection{}
	this.Items = items
	return &this
}
...
func (o *AutoscalePluginTemplateResponseModelCollection) SetContinuationTokenNil() {
...
func (o *AutoscalePluginTemplateResponseModelCollection) SetTotalItemsNil() {
...
func (o AutoscalePluginTemplateResponseModelCollection) MarshalJSON() ([]byte, error) {
...
func (o AutoscalePluginTemplateResponseModelCollection) ToMap() (map[string]interface{}, error) {
...
type NullableAutoscalePluginTemplateResponseModelCollection struct {
	value *AutoscalePluginTemplateResponseModelCollection
	isSet bool
}

func (v NullableAutoscalePluginTemplateResponseModelCollection) Get() *AutoscalePluginTemplateResponseModelCollection {
	return v.value
}

func (v *NullableAutoscalePluginTemplateResponseModelCollection) Set(val *AutoscalePluginTemplateResponseModelCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoscalePluginTemplateResponseModelCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoscalePluginTemplateResponseModelCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoscalePluginTemplateResponseModelCollection(val *AutoscalePluginTemplateResponseModelCollection) *NullableAutoscalePluginTemplateResponseModelCollection {
	return &NullableAutoscalePluginTemplateResponseModelCollection{value: val, isSet: true}
}

func (v NullableAutoscalePluginTemplateResponseModelCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoscalePluginTemplateResponseModelCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
