...
// checks if the CollectionModelOfImageDefinitionsAndImageVersionsResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionModelOfImageDefinitionsAndImageVersionsResponseModel{}

// CollectionModelOfImageDefinitionsAndImageVersionsResponseModel Response object for collections of items.
type CollectionModelOfImageDefinitionsAndImageVersionsResponseModel struct {
	// List of items.
...
type _CollectionModelOfImageDefinitionsAndImageVersionsResponseModel CollectionModelOfImageDefinitionsAndImageVersionsResponseModel
...
func NewCollectionModelOfImageDefinitionsAndImageVersionsResponseModel(items []ImageDefinitionsAndImageVersionsResponseModel) *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel {
	this := CollectionModelOfImageDefinitionsAndImageVersionsResponseModel{}
	this.Items = items
	return &this
}
...
func (o *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) SetContinuationTokenNil() {
...
func (o *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) SetTotalItemsNil() {
...
func (o CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) MarshalJSON() ([]byte, error) {
...
func (o CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel struct {
	value *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel
	isSet bool
}

func (v NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) Get() *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel {
	return v.value
}

func (v *NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) Set(val *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel(val *CollectionModelOfImageDefinitionsAndImageVersionsResponseModel) *NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel {
	return &NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel{value: val, isSet: true}
}

func (v NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionModelOfImageDefinitionsAndImageVersionsResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
