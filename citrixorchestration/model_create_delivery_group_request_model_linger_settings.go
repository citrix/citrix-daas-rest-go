...
// checks if the CreateDeliveryGroupRequestModelLingerSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDeliveryGroupRequestModelLingerSettings{}

// CreateDeliveryGroupRequestModelLingerSettings Session linger settings for sessions launched on machines in the delivery group.
type CreateDeliveryGroupRequestModelLingerSettings struct {
...
func NewCreateDeliveryGroupRequestModelLingerSettings() *CreateDeliveryGroupRequestModelLingerSettings {
	this := CreateDeliveryGroupRequestModelLingerSettings{}
...
func (o CreateDeliveryGroupRequestModelLingerSettings) MarshalJSON() ([]byte, error) {
...
func (o CreateDeliveryGroupRequestModelLingerSettings) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDeliveryGroupRequestModelLingerSettings struct {
	value *CreateDeliveryGroupRequestModelLingerSettings
	isSet bool
}

func (v NullableCreateDeliveryGroupRequestModelLingerSettings) Get() *CreateDeliveryGroupRequestModelLingerSettings {
	return v.value
}

func (v *NullableCreateDeliveryGroupRequestModelLingerSettings) Set(val *CreateDeliveryGroupRequestModelLingerSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeliveryGroupRequestModelLingerSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeliveryGroupRequestModelLingerSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeliveryGroupRequestModelLingerSettings(val *CreateDeliveryGroupRequestModelLingerSettings) *NullableCreateDeliveryGroupRequestModelLingerSettings {
	return &NullableCreateDeliveryGroupRequestModelLingerSettings{value: val, isSet: true}
}

func (v NullableCreateDeliveryGroupRequestModelLingerSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDeliveryGroupRequestModelLingerSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
